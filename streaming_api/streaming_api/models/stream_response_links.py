...
class StreamResponseLinks(BaseModel):
    ...
    StreamResponseLinks
    """ # noqa: E501
    var_self: Optional[StreamResponseLinksSelf] = Field(default=None, alias="self")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "self": StreamResponseLinksSelf.from_dict(obj.get("self")) if obj.get("self") is not None else None
        })
        return _obj
