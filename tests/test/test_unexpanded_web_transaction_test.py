...
class TestUnexpandedWebTransactionTest(unittest.TestCase):
    """UnexpandedWebTransactionTest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnexpandedWebTransactionTest:
        """Test UnexpandedWebTransactionTest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnexpandedWebTransactionTest`
        """
        model = UnexpandedWebTransactionTest()
        if include_optional:
            return UnexpandedWebTransactionTest(
                interval = 120,
                alerts_enabled = True,
                enabled = True,
...
',
    ...
    def testUnexpandedWebTransactionTest(self):
        """Test UnexpandedWebTransactionTest"""
