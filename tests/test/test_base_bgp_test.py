...
class TestBaseBgpTest(unittest.TestCase):
    """BaseBgpTest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseBgpTest:
        """Test BaseBgpTest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BaseBgpTest`
        """
        model = BaseBgpTest()
        if include_optional:
            return BaseBgpTest(
