...
class TestUnexpandedDnsSecTest(unittest.TestCase):
    """UnexpandedDnsSecTest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnexpandedDnsSecTest:
        """Test UnexpandedDnsSecTest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnexpandedDnsSecTest`
        """
        model = UnexpandedDnsSecTest()
        if include_optional:
            return UnexpandedDnsSecTest(
                interval = 120,
                alerts_enabled = True,
                enabled = True,
    ...
    def testUnexpandedDnsSecTest(self):
        """Test UnexpandedDnsSecTest"""
