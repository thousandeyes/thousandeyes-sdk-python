...
class TestUpdateBgpTestRequest(unittest.TestCase):
    """UpdateBgpTestRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateBgpTestRequest:
        """Test UpdateBgpTestRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateBgpTestRequest`
        """
        model = UpdateBgpTestRequest()
        if include_optional:
    ...
    def testUpdateBgpTestRequest(self):
        """Test UpdateBgpTestRequest"""
