...
class TestWebTransactionTest(unittest.TestCase):
    """WebTransactionTest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebTransactionTest:
        """Test WebTransactionTest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebTransactionTest`
        """
        model = WebTransactionTest()
        if include_optional:
...
',
    ...
    def testWebTransactionTest(self):
        """Test WebTransactionTest"""
