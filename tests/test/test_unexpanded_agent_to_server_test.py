...
class TestUnexpandedAgentToServerTest(unittest.TestCase):
    """UnexpandedAgentToServerTest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnexpandedAgentToServerTest:
        """Test UnexpandedAgentToServerTest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnexpandedAgentToServerTest`
        """
        model = UnexpandedAgentToServerTest()
        if include_optional:
            return UnexpandedAgentToServerTest(
                interval = 120,
                alerts_enabled = True,
                enabled = True,
    ...
    def testUnexpandedAgentToServerTest(self):
        """Test UnexpandedAgentToServerTest"""
