# tests.PathVisualizationInterfaceGroupsApi
...
with tests.ApiClient(configuration) as api_client:
    ...
    api_instance = tests.PathVisualizationInterfaceGroupsApi(api_client)
    interface_group = tests.InterfaceGroup() # InterfaceGroup | 
