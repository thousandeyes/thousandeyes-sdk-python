...
unexpanded_ftp_server_test_instance = UnexpandedFtpServerTest.from_json(json)
# print the JSON string representation of the object
print(UnexpandedFtpServerTest.to_json())

# convert the object into a dict
unexpanded_ftp_server_test_dict = unexpanded_ftp_server_test_instance.to_dict()
# create an instance of UnexpandedFtpServerTest from a dict
unexpanded_ftp_server_test_from_dict = UnexpandedFtpServerTest.from_dict(unexpanded_ftp_server_test_dict)
```
