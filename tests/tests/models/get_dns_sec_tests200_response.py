...
class GetDnsSecTests200Response(BaseModel):
    """
    GetDnsSecTests200Response
    """ # noqa: E501
    tests: Optional[List[UnexpandedDnsSecTest]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tests": [UnexpandedDnsSecTest.from_dict(_item) for _item in obj["tests"]] if obj.get("tests") is not None else None,
