...
class GetDnsTraceTests200Response(BaseModel):
    """
    GetDnsTraceTests200Response
    """ # noqa: E501
    tests: Optional[List[UnexpandedDnsTraceTest]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tests": [UnexpandedDnsTraceTest.from_dict(_item) for _item in obj["tests"]] if obj.get("tests") is not None else None,
