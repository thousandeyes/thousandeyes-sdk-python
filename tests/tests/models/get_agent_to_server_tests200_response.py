...
class GetAgentToServerTests200Response(BaseModel):
    """
    GetAgentToServerTests200Response
    """ # noqa: E501
    tests: Optional[List[UnexpandedAgentToServerTest]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tests": [UnexpandedAgentToServerTest.from_dict(_item) for _item in obj["tests"]] if obj.get("tests") is not None else None,
