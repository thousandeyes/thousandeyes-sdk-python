...
class GetDNSServerTests200Response(BaseModel):
    """
    GetDNSServerTests200Response
    """ # noqa: E501
    tests: Optional[List[UnexpandedDnsServerTest]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tests": [UnexpandedDnsServerTest.from_dict(_item) for _item in obj["tests"]] if obj.get("tests") is not None else None,
