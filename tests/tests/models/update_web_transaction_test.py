...
class UpdateWebTransactionTest(BaseModel):
    """
    ...
    agents: Optional[List[TestRequestAllOfAgents]] = Field(default=None, description="Contains list of object with required `agentId` and optional `sourceIpAddress`")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "agents": [TestRequestAllOfAgents.from_dict(_item) for _item in obj["agents"]] if obj.get("agents") is not None else None,
