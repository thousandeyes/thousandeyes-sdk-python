...
class GetHttpServerTests200Response(BaseModel):
    ...
    """ # noqa: E501
    tests: Optional[List[UnexpandedHttpServerTest]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tests": [UnexpandedHttpServerTest.from_dict(_item) for _item in obj["tests"]] if obj.get("tests") is not None else None,
