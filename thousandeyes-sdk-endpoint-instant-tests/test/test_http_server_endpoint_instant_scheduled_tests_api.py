...
class TestHTTPServerEndpointInstantScheduledTestsApi(unittest.TestCase):
    """HTTPServerEndpointInstantScheduledTestsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = HTTPServerEndpointInstantScheduledTestsApi()
