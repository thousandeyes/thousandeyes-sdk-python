...
class HTTPServerEndpointInstantScheduledTestsApi:
    ...
    @validate_call
    def create_http_server_scheduled_instant_test(
        self,
        ...
        _param = self._create_http_server_scheduled_instant_test_serialize(
    ...
    @validate_call
    def create_http_server_scheduled_instant_test_with_http_info(
        self,
        endpoint_http_server_instant_test: EndpointHttpServerInstantTest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def create_http_server_scheduled_instant_test_without_preload_content(
        self,
        endpoint_http_server_instant_test: EndpointHttpServerInstantTest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    def _create_http_server_scheduled_instant_test_serialize(
        self,
