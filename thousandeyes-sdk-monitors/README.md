...
```sh
pip install -e git+https://github.com/GIT_USER_ID/GIT_REPO_ID.git#egg=thousandeyes-sdk-monitors\&subdirectory=thousandeyes-sdk-monitors
```
(you may need to run `pip` with root permission: `sudo pip install -e git+https://github.com/GIT_USER_ID/GIT_REPO_ID.git#egg=thousandeyes-sdk-monitors\&subdirectory=thousandeyes-sdk-monitors`)
