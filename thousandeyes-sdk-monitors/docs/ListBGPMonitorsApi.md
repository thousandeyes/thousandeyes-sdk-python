# thousandeyes_sdk.monitors.ListBGPMonitorsApi
...
```python
import thousandeyes_sdk.monitors
from thousandeyes_sdk.monitors.models.monitors import Monitors
from thousandeyes_sdk.monitors.rest import ApiException
...
with thousandeyes_sdk.monitors.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = thousandeyes_sdk.monitors.ListBGPMonitorsApi(api_client)
