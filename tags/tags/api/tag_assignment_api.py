...
from tags.api_client import ApiClient, RequestSerialized
from tags.api_response import ApiResponse
from tags.rest import RESTResponseType
...
class TagAssignmentApi:
    ...
    def bulk_assign_tag(
        ...
        _param = self._bulk_assign_tag_serialize(
    ...
    @validate_call
    def bulk_assign_tag_with_http_info(
        self,
        bulk_tag_assignments: BulkTagAssignments,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def bulk_assign_tag_without_preload_content(
        self,
        bulk_tag_assignments: BulkTagAssignments,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    def _bulk_assign_tag_serialize(
        self,
    ...
    def bulk_un_assign_tag(
        ...
        _param = self._bulk_un_assign_tag_serialize(
            bulk_tag_assignments=bulk_tag_assignments,
            aid=aid,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def bulk_un_assign_tag_with_http_info(
        self,
        bulk_tag_assignments: BulkTagAssignments,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def bulk_un_assign_tag_without_preload_content(
        self,
        bulk_tag_assignments: BulkTagAssignments,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    def _bulk_un_assign_tag_serialize(
        self,
        bulk_tag_assignments,
        aid,
        _request_auth,
