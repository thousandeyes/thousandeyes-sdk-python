...
class TagsApi:
    ...
    def create_tag(
        ...
        body: Annotated[Optional[Tag], Field(description="Tag resource")] = None,
    ...
    def create_tag_bulk(
        ...
        _param = self._create_tag_bulk_serialize(
            aid=aid,
    ...
    @validate_call
    def create_tag_bulk_with_http_info(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        bulk_tag_response: Annotated[Optional[BulkTagResponse], Field(description="Tag resource")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def create_tag_bulk_without_preload_content(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        bulk_tag_response: Annotated[Optional[BulkTagResponse], Field(description="Tag resource")] = None,
        _request_timeout: Union[
    ...
    def _create_tag_bulk_serialize(
        self,
        aid,
        bulk_tag_response,
        _request_auth,
