...
class AlertSuppressionWindowsAlertSuppressionWindowsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["alertSuppressionWindowId", "name", "isEnabled", "status", "startDate", "duration", "repeat", "endRepeat", "_links"]
