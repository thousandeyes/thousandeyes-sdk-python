...
class AlertMetricDetail(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "end": AlertMetricDetailEnd.from_dict(obj["end"]) if obj.get("end") is not None else None,
            "id": obj.get("id"),
            "name": obj.get("name"),
            "start": AlertMetricDetailStart.from_dict(obj["start"]) if obj.get("start") is not None else None,
            "state": obj.get("state"),
            "type": obj.get("type")
        })
        return _obj
