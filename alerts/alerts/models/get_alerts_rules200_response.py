...
class GetAlertsRules200Response(BaseModel):
    """
    GetAlertsRules200Response
    """ # noqa: E501
    alert_rules: Optional[List[Rule]] = Field(default=None, alias="alertRules")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alertRules": [Rule.from_dict(_item) for _item in obj["alertRules"]] if obj.get("alertRules") is not None else None,
