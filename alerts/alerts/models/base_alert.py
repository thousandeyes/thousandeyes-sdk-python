...
class BaseAlert(BaseModel):
    ...
    BaseAlert
    """ # noqa: E501
    links: Optional[AlertLinksLinks] = Field(default=None, alias="_links")
    ...
    meta: Optional[BaseAlertAllOfMeta] = None
    __properties: ClassVar[List[str]] = ["_links", "id", "alertType", "startDate", "endDate", "violationCount", "duration", "suppressed", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_links": AlertLinksLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "id": obj.get("id"),
            ...
            "meta": BaseAlertAllOfMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
