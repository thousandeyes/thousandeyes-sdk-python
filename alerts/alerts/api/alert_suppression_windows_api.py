...
from alerts.api_client import ApiClient, RequestSerialized
from alerts.api_response import ApiResponse
from alerts.rest import RESTResponseType
...
class AlertSuppressionWindowsApi:
    ...
    def create_suppression_windows(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "CreateSuppressionWindows201Response",
            '400': "ValidationError",
    ...
    def create_suppression_windows_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateSuppressionWindows201Response]:
        """Create alert suppression window
    ...
    def get_suppression_window_details(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CreateSuppressionWindows201Response",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
            '429': "Error",
    ...
    def get_suppression_windows(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetSuppressionWindows200Response",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
            '429': "Error",
    ...
    def get_suppression_windows_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSuppressionWindows200Response]:
        """List alert suppression windows
