...
class GetSuppressionWindows200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "alertSuppressionWindows": [AlertSuppressionWindowsAlertSuppressionWindowsInner.from_dict(_item) for _item in obj.get("alertSuppressionWindows")] if obj.get("alertSuppressionWindows") is not None else None,
