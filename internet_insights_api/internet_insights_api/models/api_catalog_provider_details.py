...
class ApiCatalogProviderDetails(BaseModel):
    ...
    locations: Optional[List[ApiCatalogProviderDetailsLocationsInner]] = Field(default=None, description="List of locations covered by the Provider.")
    __properties: ClassVar[List[str]] = ["id", "providerName", "providerType", "region", "dataType", "asns", "locations"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "asns": [ApiAsn.from_dict(_item) for _item in obj.get("asns")] if obj.get("asns") is not None else None,
            "locations": [ApiCatalogProviderDetailsLocationsInner.from_dict(_item) for _item in obj.get("locations")] if obj.get("locations") is not None else None
        })
        return _obj
