...
class ApiNetworkOutageDetails(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "providerName", "providerType", "networkName", "asn", "startDate", "startRoundId", "endDate", "endRoundId", "duration", "affectedTests", "affectedDomains", "affectedAgents", "affectedLocations"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "affectedLocations": [ApiNetworkOutageAffectedLocation.from_dict(_item) for _item in obj.get("affectedLocations")] if obj.get("affectedLocations") is not None else None
        })
        return _obj
