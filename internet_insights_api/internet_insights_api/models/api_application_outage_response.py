...
class ApiApplicationOutageResponse(BaseModel):
    """
    ...
    application_name: Optional[StrictStr] = Field(default=None, description="The name of the affected application.", alias="applicationName")
    ...
    errors: Optional[List[StrictStr]] = Field(default=None, description="List of errors.")
    affected_locations: Optional[List[ApiApplicationOutageAffectedLocation]] = Field(default=None, description="List of affected locations.", alias="affectedLocations")
    links: Optional[SelfLinksLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["id", "providerName", "providerType", "applicationName", "startDate", "startRoundId", "endDate", "endRoundId", "duration", "affectedTests", "affectedDomains", "affectedAgents", "errors", "affectedLocations", "_links"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "affectedTests": [ApiAffectedTest.from_dict(_item) for _item in obj.get("affectedTests")] if obj.get("affectedTests") is not None else None,
            "affectedDomains": obj.get("affectedDomains"),
            "affectedAgents": [ApiAffectedAgent.from_dict(_item) for _item in obj.get("affectedAgents")] if obj.get("affectedAgents") is not None else None,
            "errors": obj.get("errors"),
            "affectedLocations": [ApiApplicationOutageAffectedLocation.from_dict(_item) for _item in obj.get("affectedLocations")] if obj.get("affectedLocations") is not None else None,
