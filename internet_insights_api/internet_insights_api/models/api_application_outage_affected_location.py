...
class ApiApplicationOutageAffectedLocation(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "affectedServers": [ApiApplicationOutageAffectedServer.from_dict(_item) for _item in obj.get("affectedServers")] if obj.get("affectedServers") is not None else None
        })
        return _obj
