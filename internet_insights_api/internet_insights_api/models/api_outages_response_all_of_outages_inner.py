...
class ApiOutagesResponseAllOfOutagesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "providerName", "providerType", "name", "startDate", "startRoundId", "endDate", "endRoundId", "duration", "affectedTestsCount", "affectedServersCount", "affectedLocationsCount", "_links"]
