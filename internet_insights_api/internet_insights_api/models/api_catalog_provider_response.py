...
class ApiCatalogProviderResponse(BaseModel):
    """
    ApiCatalogProviderResponse
    """ # noqa: E501
    links: Optional[SelfLinksLinks] = Field(default=None, alias="_links")
    providers: Optional[List[ApiCatalogProviderResponseAllOfProvidersInner]] = Field(default=None, description="List of catalog providers.")
    __properties: ClassVar[List[str]] = ["_links", "providers"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "providers": [ApiCatalogProviderResponseAllOfProvidersInner.from_dict(_item) for _item in obj.get("providers")] if obj.get("providers") is not None else None
        })
        return _obj
