...
```python
from internet_insights_api.models.api_application_outage_details import ApiApplicationOutageDetails
...
api_application_outage_details_form_dict = api_application_outage_details.from_dict(api_application_outage_details_dict)
```
