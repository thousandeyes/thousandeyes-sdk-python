    ...
    def make_instance(self, include_optional) -> ApiCatalogProviderDetailsResponse:
        ...
        if include_optional:
            return ApiCatalogProviderDetailsResponse(
                ...
                asns = [
                    internet_insights_api.models.api_asn.ApiAsn(
                        id = 1, 
                        name = 'LVLT-1 - Level 3 Communications, Inc.', )
                    ],
                locations = [
                    internet_insights_api.models.api_catalog_provider_details_locations_inner.ApiCatalogProviderDetails_locations_inner(
