...
class TestApiAffectedTest(unittest.TestCase):
    """ApiAffectedTest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiAffectedTest:
        """Test ApiAffectedTest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiAffectedTest`
        """
        model = ApiAffectedTest()
        if include_optional:
            return ApiAffectedTest(
                id = 5,
                name = 'amazon-test2'
            )
        else:
