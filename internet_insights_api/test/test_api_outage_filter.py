...
class TestApiOutageFilter(unittest.TestCase):
    """ApiOutageFilter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiOutageFilter:
        """Test ApiOutageFilter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiOutageFilter`
        """
        model = ApiOutageFilter()
        if include_optional:
            return ApiOutageFilter(
                start_date = '2022-03-01T01:30:00Z',
                end_date = '2022-03-01T23:30:15Z',
                window = '1d',
                outage_scope = 'all',
                provider_name = ["Telia","Amazon"],
                application_name = ["slack","facebook"],
                interface_network = [
                    ''
                    ]
            )
