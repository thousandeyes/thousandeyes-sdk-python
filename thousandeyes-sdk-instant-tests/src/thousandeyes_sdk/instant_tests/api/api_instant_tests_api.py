...
class APIInstantTestsApi:
    ...
    def create_api_instant_test(
        ...
        :param api_instant_test_request: (required)
        :type api_instant_test_request: ApiInstantTestRequest
        ...
        _param = self._create_api_instant_test_serialize(
    ...
    @validate_call
    def create_api_instant_test_with_http_info(
        self,
        api_instant_test_request: ApiInstantTestRequest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        expand: Annotated[Optional[List[ExpandInstantTestOptions]], Field(description="(Optional) Indicates if the test sub-resources should be expanded. Defaults to no expansion. To expand the `agents` sub-resource, use the query `?expand=agent`.")] = None,
    ...
    @validate_call
    def create_api_instant_test_without_preload_content(
        self,
        api_instant_test_request: ApiInstantTestRequest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        expand: Annotated[Optional[List[ExpandInstantTestOptions]], Field(description="(Optional) Indicates if the test sub-resources should be expanded. Defaults to no expansion. To expand the `agents` sub-resource, use the query `?expand=agent`.")] = None,
    ...
    def _create_api_instant_test_serialize(
        self,
        ...
        if api_instant_test_request is not None:
            _body_params = api_instant_test_request
