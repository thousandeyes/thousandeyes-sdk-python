...
class ApiRequestAssertion(BaseModel):
    """
    ApiRequestAssertion
    """ # noqa: E501
    name: Optional[ApiRequestAssertionName] = None
    operator: Optional[ApiRequestAssertionOperator] = None
    value: Optional[StrictStr] = Field(default=None, description="The value of the assertion. If name = `status-code`, the status code to assert. If name = `response-body`, the lookup value to assert.")
