...
class TestAPIInstantTestsApi(unittest.TestCase):
    """APIInstantTestsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = APIInstantTestsApi()

    def tearDown(self) -> None:
        pass

    def test_create_api_instant_test_models_validation(self) -> None:
        """Test case for create_api_instant_test request and response models"""
        request_body_json = """
                {
        ...
        response_from_json = thousandeyes_sdk.instant_tests.models.ApiInstantTestResponse.from_json(response_body_json)
