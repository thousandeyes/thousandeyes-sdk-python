...
class TestHTTPServerInstantTestsApi(unittest.TestCase):
    """HTTPServerInstantTestsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = HTTPServerInstantTestsApi()
    ...
    def test_create_http_server_instant_test_models_validation(self) -> None:
        ...
        response_from_json = thousandeyes_sdk.instant_tests.models.HttpServerInstantTestResponse.from_json(response_body_json)
