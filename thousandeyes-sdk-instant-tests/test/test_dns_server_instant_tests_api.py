...
class TestDNSServerInstantTestsApi(unittest.TestCase):
    """DNSServerInstantTestsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = DNSServerInstantTestsApi()

    def tearDown(self) -> None:
        pass

    def test_create_dns_server_instant_test_models_validation(self) -> None:
        """Test case for create_dns_server_instant_test request and response models"""
        request_body_json = """
                {
        ...
        response_from_json = thousandeyes_sdk.instant_tests.models.DnsServerInstantTestResponse.from_json(response_body_json)
