...
class TestWebTransactionInstantTestsApi(unittest.TestCase):
    """WebTransactionInstantTestsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = WebTransactionInstantTestsApi()
    ...
    def test_create_web_transaction_instant_test_models_validation(self) -> None:
        ...
        response_from_json = thousandeyes_sdk.instant_tests.models.WebTransactionInstantTestResponse.from_json(response_body_json)
