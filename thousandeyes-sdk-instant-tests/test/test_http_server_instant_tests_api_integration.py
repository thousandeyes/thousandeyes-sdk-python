...
class TestHTTPServerInstantTestsApiIntegration(IntegrationTestBase):
    """HTTPServerInstantTestsApi integration test stubs"""

    def setUp(self) -> None:
        super().setUp()
        self.api = HTTPServerInstantTestsApi(self.api_client)


    def test_create_http_server_instant_test_happy_path(self) -> None:
        """Integration test for create_http_server_instant_test success path"""
        request_body_json = """
    ...
    def test_create_http_server_instant_test_error_400(self) -> None:
        """Integration test for create_http_server_instant_test error path (HTTP 400)"""
        request_body_json = """
    ...
    def test_create_http_server_instant_test_error_401(self) -> None:
        """Integration test for create_http_server_instant_test error path (HTTP 401)"""
        request_body_json = """
    ...
    def test_create_http_server_instant_test_error_403(self) -> None:
        """Integration test for create_http_server_instant_test error path (HTTP 403)"""
        request_body_json = """
    ...
    def test_create_http_server_instant_test_error_404(self) -> None:
        """Integration test for create_http_server_instant_test error path (HTTP 404)"""
        request_body_json = """
    ...
    def test_create_http_server_instant_test_error_429(self) -> None:
        """Integration test for create_http_server_instant_test error path (HTTP 429)"""
        request_body_json = """
    ...
    def test_create_http_server_instant_test_error_500(self) -> None:
        """Integration test for create_http_server_instant_test error path (HTTP 500)"""
        request_body_json = """
    ...
    def test_create_http_server_instant_test_error_502(self) -> None:
        """Integration test for create_http_server_instant_test error path (HTTP 502)"""
        request_body_json = """
