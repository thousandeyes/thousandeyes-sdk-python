# thousandeyes_sdk.instant_tests.AgentToServerInstantTestsApi

All URIs are relative to *https://api.thousandeyes.com/v7*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_agent_to_server_instant_test**](AgentToServerInstantTestsApi.md#create_agent_to_server_instant_test) | **POST** /tests/agent-to-server/instant | Create agent-to-server instant test


# **create_agent_to_server_instant_test**
> AgentToServerInstantTestResponse create_agent_to_server_instant_test(agent_to_server_instant_test_request, aid=aid, expand=expand)
...
with thousandeyes_sdk.core.ApiClient(configuration) as api_client:
    ...
    expand = ["agent"] # List[ExpandInstantTestOptions] | (Optional) Indicates if the test sub-resources should be expanded. Defaults to no expansion. To expand the `agents` sub-resource, use the query `?expand=agent`. (optional)
    ...
    try:
        ...
        print("Exception when calling AgentToServerInstantTestsApi->create_agent_to_server_instant_test: %s\n" % e)
```
