...
http_server_instant_test_response_instance = HttpServerInstantTestResponse.from_json(json)
# print the JSON string representation of the object
print(HttpServerInstantTestResponse.to_json())

# convert the object into a dict
http_server_instant_test_response_dict = http_server_instant_test_response_instance.to_dict()
# create an instance of HttpServerInstantTestResponse from a dict
http_server_instant_test_response_from_dict = HttpServerInstantTestResponse.from_dict(http_server_instant_test_response_dict)
```
