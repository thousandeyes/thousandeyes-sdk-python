...
dns_sec_instant_test_response_instance = DnsSecInstantTestResponse.from_json(json)
# print the JSON string representation of the object
print(DnsSecInstantTestResponse.to_json())

# convert the object into a dict
dns_sec_instant_test_response_dict = dns_sec_instant_test_response_instance.to_dict()
# create an instance of DnsSecInstantTestResponse from a dict
dns_sec_instant_test_response_from_dict = DnsSecInstantTestResponse.from_dict(dns_sec_instant_test_response_dict)
```
