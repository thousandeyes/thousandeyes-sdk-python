# thousandeyes_sdk.instant_tests.APIInstantTestsApi

All URIs are relative to *https://api.thousandeyes.com/v7*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_api_instant_test**](APIInstantTestsApi.md#create_api_instant_test) | **POST** /tests/api/instant | Create API instant test


# **create_api_instant_test**
> ApiInstantTestResponse create_api_instant_test(api_instant_test_request, aid=aid, expand=expand)
