...
page_load_instant_test_response_instance = PageLoadInstantTestResponse.from_json(json)
# print the JSON string representation of the object
print(PageLoadInstantTestResponse.to_json())

# convert the object into a dict
page_load_instant_test_response_dict = page_load_instant_test_response_instance.to_dict()
# create an instance of PageLoadInstantTestResponse from a dict
page_load_instant_test_response_from_dict = PageLoadInstantTestResponse.from_dict(page_load_instant_test_response_dict)
```
