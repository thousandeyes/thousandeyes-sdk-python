...
class TestApiWidgetData(unittest.TestCase):
    """ApiWidgetData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiWidgetData:
        """Test ApiWidgetData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiWidgetData`
        """
        model = ApiWidgetData()
        if include_optional:
            return ApiWidgetData(
                group_labels = [
