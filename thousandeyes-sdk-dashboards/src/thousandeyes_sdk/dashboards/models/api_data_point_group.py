...
class ApiDataPointGroup(BaseModel):
    """
    ...
    group_value: Optional[StrictStr] = Field(default=None, description="The value of a group.", alias="groupValue")
    __properties: ClassVar[List[str]] = ["groupProperty", "groupValue"]
