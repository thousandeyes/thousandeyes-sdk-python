...
# **dashboard_snapshots**
> DashboardSnapshotsPage dashboard_snapshots(aid=aid, dashboard_id=dashboard_id, cursor=cursor)
...
> ApiWidgetDataSnapshotResponse snapshot_data_by_widget(snapshot_id, widget_id, aid=aid)
