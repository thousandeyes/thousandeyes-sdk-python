        ...
        if include_optional:
            return NetworkProfile(
                ...
                wireless_profile = endpoint_test_results.models.network_wireless_profile.NetworkWirelessProfile(
                    ...
                    tx_rate = 130, 
                    vendor = 'Cisco', ),
                proxy_profile = endpoint_test_results.models.network_proxy_profile.NetworkProxyProfile(
                    method = 'System', 
                    proxies = [
                        endpoint_test_results.models.network_proxy_profile_proxies_inner.NetworkProxyProfile_proxies_inner(
                            bypass = '*.local;169.254/16', 
                            proxy = '<direct>', )
                        ], ),
                ethernet_profile = endpoint_test_results.models.ethernet_profile.EthernetProfile(
                    link_speed = 860, ),
