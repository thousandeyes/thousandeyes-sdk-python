...
from endpoint_test_results.api_client import ApiClient, RequestSerialized
from endpoint_test_results.api_response import ApiResponse
from endpoint_test_results.rest import RESTResponseType
...
class NetworkScheduledTestsResultsApi:
    ...
    def get_test_result_network_pathvis(
        ...
        _param = self._get_test_result_network_pathvis_serialize(
            test_id=test_id,
            aid=aid,
            window=window,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetTestResultNetworkPathvis200Response",
    ...
    @validate_call
    def get_test_result_network_pathvis_with_http_info(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        window: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="A dynamic time interval up to the current time of the request. Specify the interval as a number followed by an optional type: `s` for seconds (default if no type is specified), `m` for minutes, `h` for hours, `d` for days, and `w` for weeks. For a precise date range, use `startDate` and `endDate`.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetTestResultNetworkPathvis200Response]:
        """Retrieve path visualization network scheduled test results
    ...
    @validate_call
    def get_test_result_network_pathvis_without_preload_content(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        window: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="A dynamic time interval up to the current time of the request. Specify the interval as a number followed by an optional type: `s` for seconds (default if no type is specified), `m` for minutes, `h` for hours, `d` for days, and `w` for weeks. For a precise date range, use `startDate` and `endDate`.")] = None,
    ...
    def _get_test_result_network_pathvis_serialize(
        self,
        test_id,
        aid,
        window,
    ...
    @validate_call
    def get_test_result_pathvis_agent_round(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        ...
        _param = self._get_test_result_pathvis_agent_round_serialize(
            test_id=test_id,
            agent_id=agent_id,
            round_id=round_id,
            aid=aid,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetTestResultPathvisAgentRound200Response",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
            '429': "Error",
    ...
    @validate_call
    def get_test_result_pathvis_agent_round_with_http_info(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        agent_id: Annotated[StrictStr, Field(description="Agent ID")],
        round_id: Annotated[StrictStr, Field(description="Round ID")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetTestResultPathvisAgentRound200Response]:
        """Retrieve path visualization network scheduled test results details
    ...
    @validate_call
    def get_test_result_pathvis_agent_round_without_preload_content(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        agent_id: Annotated[StrictStr, Field(description="Agent ID")],
        round_id: Annotated[StrictStr, Field(description="Round ID")],
    ...
    def _get_test_result_pathvis_agent_round_serialize(
        self,
        test_id,
        agent_id,
        round_id,
    ...
    def post_fetch_test_result_metrics(
        ...
        end_date: Annotated[Optional[datetime], Field(description="Defaults to current time the request is made. Use with the `startDate` parameter. Include the complete time (hours, minutes, and seconds) in UTC time zone, following the ISO 8601 date-time format. See the example for reference. Please note that this parameter can't be used with `window`.")] = None,
        cursor: Annotated[Optional[StrictStr], Field(description="(Optional) Opaque cursor used for pagination. Clients should use `next` value from `_links` instead of this parameter.")] = None,
        tests_data_rounds_search: Annotated[Optional[TestsDataRoundsSearch], Field(description="Tests data search filters.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param cursor: (Optional) Opaque cursor used for pagination. Clients should use `next` value from `_links` instead of this parameter.
        :type cursor: str
        :param tests_data_rounds_search: Tests data search filters.
        :type tests_data_rounds_search: TestsDataRoundsSearch
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_fetch_test_result_metrics_serialize(
            test_id=test_id,
            aid=aid,
            window=window,
            start_date=start_date,
            end_date=end_date,
            cursor=cursor,
            tests_data_rounds_search=tests_data_rounds_search,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PostFetchTestResultMetrics200Response",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
            '429': "Error",
    ...
    @validate_call
    def post_fetch_test_result_metrics_with_http_info(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        window: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="A dynamic time interval up to the current time of the request. Specify the interval as a number followed by an optional type: `s` for seconds (default if no type is specified), `m` for minutes, `h` for hours, `d` for days, and `w` for weeks. For a precise date range, use `startDate` and `endDate`.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PostFetchTestResultMetrics200Response]:
        """Retrieve network scheduled test results
    ...
    @validate_call
    def post_fetch_test_result_metrics_without_preload_content(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        window: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="A dynamic time interval up to the current time of the request. Specify the interval as a number followed by an optional type: `s` for seconds (default if no type is specified), `m` for minutes, `h` for hours, `d` for days, and `w` for weeks. For a precise date range, use `startDate` and `endDate`.")] = None,
    ...
    def _post_fetch_test_result_metrics_serialize(
        self,
        test_id,
        aid,
        window,
        ...
        # process the form parameters
        # process the body parameter
        if tests_data_rounds_search is not None:
            _body_params = tests_data_rounds_search
    ...
    def post_fetch_test_result_metrics_multi_test(
        ...
        cursor: Annotated[Optional[StrictStr], Field(description="(Optional) Opaque cursor used for pagination. Clients should use `next` value from `_links` instead of this parameter.")] = None,
        multi_test_id_tests_data_rounds_search: Annotated[Optional[MultiTestIdTestsDataRoundsSearch], Field(description="Test data search filters.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param cursor: (Optional) Opaque cursor used for pagination. Clients should use `next` value from `_links` instead of this parameter.
        :type cursor: str
        :param multi_test_id_tests_data_rounds_search: Test data search filters.
        :type multi_test_id_tests_data_rounds_search: MultiTestIdTestsDataRoundsSearch
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_fetch_test_result_metrics_multi_test_serialize(
            aid=aid,
            window=window,
            start_date=start_date,
            end_date=end_date,
            max=max,
            cursor=cursor,
            multi_test_id_tests_data_rounds_search=multi_test_id_tests_data_rounds_search,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PostFetchTestResultMetricsMultiTest200Response",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
            '429': "Error",
    ...
    def post_fetch_test_result_metrics_multi_test_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PostFetchTestResultMetricsMultiTest200Response]:
        """Retrieve network scheduled test results from multiple tests
    ...
    def _post_fetch_test_result_metrics_multi_test_serialize(
        self,
        aid,
        window,
        start_date,
        ...
        max,
        cursor,
        multi_test_id_tests_data_rounds_search,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if multi_test_id_tests_data_rounds_search is not None:
            _body_params = multi_test_id_tests_data_rounds_search
