...
class RealUserTestNetwork(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gatewayPing": RealUserTestNetworkGatewayPing.from_dict(obj["gatewayPing"]) if obj.get("gatewayPing") is not None else None,
            "ping": RealUserTestNetworkPing.from_dict(obj["ping"]) if obj.get("ping") is not None else None,
            "traceroute": RealUserTestNetworkTraceroute.from_dict(obj["traceroute"]) if obj.get("traceroute") is not None else None,
            "connectRtt": obj.get("connectRtt"),
            "isIcmpBlocked": obj.get("isIcmpBlocked"),
            "errors": obj.get("errors"),
            "vpnPing": RealUserTestNetworkVpnPing.from_dict(obj["vpnPing"]) if obj.get("vpnPing") is not None else None,
            "vpnTraceroute": RealUserTestNetworkVpnTraceroute.from_dict(obj["vpnTraceroute"]) if obj.get("vpnTraceroute") is not None else None
        })
        return _obj
