...
class GetDynamicTestResultNetworkPathvis200Response(BaseModel):
    """
    GetDynamicTestResultNetworkPathvis200Response
    """ # noqa: E501
    results: Optional[List[PathVisDynamicTestResult]] = None
    ...
    links: Optional[PaginationNextAndSelfLinkLinks] = Field(default=None, alias="_links")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [PathVisDynamicTestResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "test": DynamicTest.from_dict(obj["test"]) if obj.get("test") is not None else None,
            "startDate": obj.get("startDate"),
            "endDate": obj.get("endDate"),
            "_links": PaginationNextAndSelfLinkLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
