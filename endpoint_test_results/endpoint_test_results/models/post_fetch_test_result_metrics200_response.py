...
class PostFetchTestResultMetrics200Response(BaseModel):
    """
    PostFetchTestResultMetrics200Response
    """ # noqa: E501
    results: Optional[List[NetworkTestResult]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [NetworkTestResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "totalHits": obj.get("totalHits"),
            "test": EndpointScheduledTest.from_dict(obj["test"]) if obj.get("test") is not None else None,
            "startDate": obj.get("startDate"),
            "endDate": obj.get("endDate"),
            "_links": PaginationNextLinkLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
