...
class PathVisDynamicTestResult(BaseModel):
    ...
    path_traces: Optional[List[PathVisEndpoint]] = Field(default=None, description="Shows an iteration of path trace, with each iteration specified by a pathId.", alias="pathTraces")
    __properties: ClassVar[List[str]] = ["aid", "agentId", "roundId", "serverIp", "networkProfile", "systemMetrics", "vpnProfile", "asnDetails", "server", "sourceIp", "sourcePrefix", "application", "webex", "location", "pathTraces"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "webex": DynamicBaseTestResultWebex.from_dict(obj["webex"]) if obj.get("webex") is not None else None,
            "location": obj.get("location"),
            "pathTraces": [PathVisEndpoint.from_dict(_item) for _item in obj["pathTraces"]] if obj.get("pathTraces") is not None else None
        })
        return _obj
