...
class GetEndpointHttpserverTestsList200Response(BaseModel):
    """
    GetEndpointHttpserverTestsList200Response
    """ # noqa: E501
    tests: Optional[List[EndpointHttpServerTest]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tests": [EndpointHttpServerTest.from_dict(_item) for _item in obj["tests"]] if obj.get("tests") is not None else None,
