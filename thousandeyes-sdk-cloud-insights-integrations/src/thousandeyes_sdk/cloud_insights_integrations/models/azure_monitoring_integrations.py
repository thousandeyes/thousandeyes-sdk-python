...
class AzureMonitoringIntegrations(BaseModel):
    """
    A HAL resource containing a list of Azure inventory and flow logs monitoring integrations.
    """ # noqa: E501
    integrations: List[AzureMonitoringIntegration] = Field(description="The list of Azure inventory and flow logs monitoring integrations.")
    links: Optional[SelfLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["integrations", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integrations": [AzureMonitoringIntegration.from_dict(_item) for _item in obj["integrations"]] if obj.get("integrations") is not None else None,
