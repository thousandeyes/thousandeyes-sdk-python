...
class AwsInventoryIntegrationRequest(BaseModel):
    """
    AwsInventoryIntegrationRequest
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the AWS inventory monitoring integration.")
    role_arn: StrictStr = Field(description="The ARN of the AWS role to be monitored.", alias="roleArn")
    __properties: ClassVar[List[str]] = ["name", "roleArn"]
