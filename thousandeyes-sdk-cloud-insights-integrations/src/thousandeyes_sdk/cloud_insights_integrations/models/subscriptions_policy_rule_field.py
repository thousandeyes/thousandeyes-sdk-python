...
class SubscriptionsPolicyRuleField(str, Enum):
    """
    ...
    allowed enum values
    """
    SUBSCRIPTION_MINUS_ID = 'subscription-id'
    SUBSCRIPTION_MINUS_NAME = 'subscription-name'
    UNKNOWN = 'unknown'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SubscriptionsPolicyRuleField from a JSON string"""
