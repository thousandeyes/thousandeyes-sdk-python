...
class AwsMonitoringIntegrations(BaseModel):
    """
    A HAL resource containing a list of AWS monitoring integrations and navigation links.
    """ # noqa: E501
    integrations: List[AwsMonitoringIntegration] = Field(description="The list of AWS inventory and flow logs monitoring integrations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integrations": [AwsMonitoringIntegration.from_dict(_item) for _item in obj["integrations"]] if obj.get("integrations") is not None else None,
