...
class AzureFlowLogsIntegrationRequest(BaseModel):
    """
    AzureFlowLogsIntegrationRequest
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the Azure flow logs monitoring integration.")
    app_id: StrictStr = Field(description="The Application (client) ID of the service principal.", alias="appId")
    password: StrictStr = Field(description="The client secret value.")
    azure_tenant_id: StrictStr = Field(description="The Azure Active Directory tenant ID.", alias="azureTenantId")
    service_bus_queue_url: StrictStr = Field(description="The URL of the Service Bus Queue.", alias="serviceBusQueueUrl")
    __properties: ClassVar[List[str]] = ["name", "appId", "password", "azureTenantId", "serviceBusQueueUrl"]
