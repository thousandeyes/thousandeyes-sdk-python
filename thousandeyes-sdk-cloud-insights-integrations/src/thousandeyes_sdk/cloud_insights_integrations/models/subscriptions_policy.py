...
class SubscriptionsPolicy(BaseModel):
    """
    ...
    """ # noqa: E501
    rules: Annotated[List[SubscriptionsPolicyRule], Field(max_length=10)] = Field(description="Ordered list of subscription policy rules. Maximum of 10 entries.")
    default_action: SubscriptionsPolicyRuleAction = Field(alias="defaultAction")
    __properties: ClassVar[List[str]] = ["rules", "defaultAction"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rules": [SubscriptionsPolicyRule.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None,
