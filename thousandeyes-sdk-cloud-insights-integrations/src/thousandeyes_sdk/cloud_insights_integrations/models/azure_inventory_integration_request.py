...
class AzureInventoryIntegrationRequest(BaseModel):
    """
    AzureInventoryIntegrationRequest
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the Azure inventory monitoring integration.")
    ...
    __properties: ClassVar[List[str]] = ["name", "appId", "password", "azureTenantId"]
