...
class AzureResourceGroupType(str, Enum):
    """
    ...
    AFD = 'afd'
    SECURITY = 'security'
    EXPRESS_MINUS_ROUTE = 'express-route'
    VIRTUAL_MINUS_WAN = 'virtual-wan'
    TRAFFIC_MINUS_MANAGER = 'traffic-manager'
    NETWORKING = 'networking'
    UNKNOWN = 'unknown'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AzureResourceGroupType from a JSON string"""
