...
class AwsFlowLogsIntegrationRequest(BaseModel):
    """
    AwsFlowLogsIntegrationRequest
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the AWS flow logs monitoring integration.")
    role_arn: StrictStr = Field(description="The ARN of the AWS role to be monitored.", alias="roleArn")
    sns_topics_arns: List[StrictStr] = Field(description="The array of SNS topics ARNs.", alias="snsTopicsArns")
    __properties: ClassVar[List[str]] = ["name", "roleArn", "snsTopicsArns"]
