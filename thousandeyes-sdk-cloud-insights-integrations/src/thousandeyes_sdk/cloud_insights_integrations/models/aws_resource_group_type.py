...
class AwsResourceGroupType(str, Enum):
    """
    ...
    EC2 = 'ec2'
    EKS_MINUS_ECS = 'eks-ecs'
    GLOBAL_MINUS_ACCELERATOR = 'global-accelerator'
    DIRECT_MINUS_CONNECT = 'direct-connect'
    S3_MINUS_BUCKET = 's3-bucket'
    NETWORK_MINUS_FIREWALL = 'network-firewall'
    GLOBAL_MINUS_NETWORK = 'global-network'
    UNKNOWN = 'unknown'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AwsResourceGroupType from a JSON string"""
