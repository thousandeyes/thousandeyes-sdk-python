...
# **get_user_events**
> GetUserEvents200Response get_user_events(aid=aid, window=window, start_date=start_date, end_date=end_date, cursor=cursor)
...
with admin_api.ApiClient(configuration) as api_client:
    ...
    api_instance = admin_api.UserEventsApi(api_client)
    ...
    try:
        # List activity log events
        api_response = api_instance.get_user_events(aid=aid, window=window, start_date=start_date, end_date=end_date, cursor=cursor)
