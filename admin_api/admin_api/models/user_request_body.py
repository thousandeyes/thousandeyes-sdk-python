...
class UserRequestBody(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "accountGroupRoles": [AccountGroupRolesRequestBodyInner.from_dict(_item) for _item in obj.get("accountGroupRoles")] if obj.get("accountGroupRoles") is not None else None,
