...
class CreateUser201Response(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "loginAccountGroup": AccountGroup1.from_dict(obj.get("loginAccountGroup")) if obj.get("loginAccountGroup") is not None else None,
            "accountGroupRoles": [AccountGroupRolesAccountGroupRolesInner.from_dict(_item) for _item in obj.get("accountGroupRoles")] if obj.get("accountGroupRoles") is not None else None,
            "allAccountGroupRoles": [Role.from_dict(_item) for _item in obj.get("allAccountGroupRoles")] if obj.get("allAccountGroupRoles") is not None else None,
