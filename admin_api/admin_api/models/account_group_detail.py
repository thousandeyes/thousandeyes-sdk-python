...
class AccountGroupDetail(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "users": [UserAccountGroup.from_dict(_item) for _item in obj.get("users")] if obj.get("users") is not None else None,
            "agents": [EnterpriseAgent.from_dict(_item) for _item in obj.get("agents")] if obj.get("agents") is not None else None
        })
        return _obj
