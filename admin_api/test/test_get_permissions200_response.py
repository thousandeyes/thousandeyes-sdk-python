...
class TestGetPermissions200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPermissions200Response:
        """Test GetPermissions200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPermissions200Response`
        """
        model = GetPermissions200Response()
        if include_optional:
    ...
    def testGetPermissions200Response(self):
        """Test GetPermissions200Response"""
