...
class TestUserRequestBody(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UserRequestBody:
        """Test UserRequestBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserRequestBody`
        """
        ...
        if include_optional:
            return UserRequestBody(
                ...
                account_group_roles = [
                    admin_api.models.account_group_roles_request_body_inner.AccountGroupRolesRequestBody_inner(
