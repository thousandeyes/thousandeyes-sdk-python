...
class ApiTableWidget(BaseModel):
    """
    ...
    type: Annotated[str, Field(strict=True)] = Field(description="Table widget type.")
    ...
    data_source: Optional[TableDatasource] = Field(default=None, alias="dataSource")
    __properties: ClassVar[List[str]] = ["id", "title", "visualMode", "embedUrl", "isEmbedded", "metricGroup", "direction", "metric", "filters", "measure", "fixedTimespan", "apiLink", "shouldExcludeAlertSuppressionWindows", "_links", "type", "compareToPreviousValue", "rowGroupBy", "columnGroupBy", "sortBy", "sortDirection", "limit", "dataSource"]

    @field_validator('type')
    def type_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^Table$", value):
            raise ValueError(r"must validate the regular expression /^Table$/")
        return value
