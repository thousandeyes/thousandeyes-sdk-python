...
class ApiGeoMapWidget(BaseModel):
    """
    ...
    type: Annotated[str, Field(strict=True)] = Field(description="Map widget type.")
    group_by: Optional[ApiAggregateProperty] = Field(default=None, alias="groupBy")
    is_geo_map_per_test: Optional[StrictBool] = Field(default=None, description="Indicates whether a separate map is displayed for each test within the widget. When set to true, individual maps are generated.", alias="isGeoMapPerTest")
    ...
    data_source: Optional[GeoMapDatasource] = Field(default=None, alias="dataSource")
    __properties: ClassVar[List[str]] = ["id", "title", "visualMode", "embedUrl", "isEmbedded", "metricGroup", "direction", "metric", "filters", "measure", "fixedTimespan", "apiLink", "shouldExcludeAlertSuppressionWindows", "_links", "minScale", "maxScale", "unit", "type", "groupBy", "isGeoMapPerTest", "sortBy", "sortDirection", "dataSource"]

    @field_validator('type')
    def type_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^Map$", value):
            raise ValueError(r"must validate the regular expression /^Map$/")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isGeoMapPerTest": obj.get("isGeoMapPerTest"),
