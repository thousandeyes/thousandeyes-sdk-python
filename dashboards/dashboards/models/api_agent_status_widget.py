...
class ApiAgentStatusWidget(BaseModel):
    """
    ...
    type: Annotated[str, Field(strict=True)] = Field(description="Agent Status widget type.")
    agents: Optional[LegacyAgentWidgetType] = None
    show: Optional[LegacyAgentWidgetShow] = None
    data_source: Optional[AgentStatusDatasource] = Field(default=None, alias="dataSource")
    __properties: ClassVar[List[str]] = ["id", "title", "visualMode", "embedUrl", "isEmbedded", "metricGroup", "direction", "metric", "filters", "measure", "fixedTimespan", "apiLink", "shouldExcludeAlertSuppressionWindows", "_links", "type", "agents", "show", "dataSource"]

    @field_validator('type')
    def type_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^Agent Status$", value):
            raise ValueError(r"must validate the regular expression /^Agent Status$/")
        return value
