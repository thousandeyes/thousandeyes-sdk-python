...
class ApiBoxAndWhiskersWidget(BaseModel):
    ...
    type: Annotated[str, Field(strict=True)] = Field(description="Box and Whiskers widget type.")
    ...
    def type_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^Box and Whiskers$", value):
            raise ValueError(r"must validate the regular expression /^Box and Whiskers$/")
        return value
