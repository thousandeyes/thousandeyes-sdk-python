...
class ApiStackedBarchartWidget(BaseModel):
    ...
    type: Annotated[str, Field(strict=True)] = Field(description="Bar Chart: Stacked widget type.")
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "visualMode", "embedUrl", "isEmbedded", "metricGroup", "direction", "metric", "filters", "measure", "fixedTimespan", "apiLink", "shouldExcludeAlertSuppressionWindows", "_links", "type", "axisGroupBy", "sortBy", "sortDirection", "limit", "showLabels", "isHorizontalBarChart", "dataSource"]

    @field_validator('type')
    def type_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^Bar Chart: Stacked$", value):
            raise ValueError(r"must validate the regular expression /^Bar Chart: Stacked$/")
        return value
