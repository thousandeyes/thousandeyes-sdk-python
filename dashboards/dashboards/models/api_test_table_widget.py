...
class ApiTestTableWidget(BaseModel):
    """
    ...
    type: Annotated[str, Field(strict=True)] = Field(description="Test Table widget type,")
    filter: Optional[ApiWidgetFilterApiTestTableFilterKey] = None
    exclude: Optional[ApiWidgetFilterApiTestTableFilterKey] = None
    data_source: Optional[TestTableDatasource] = Field(default=None, alias="dataSource")
    __properties: ClassVar[List[str]] = ["id", "title", "visualMode", "embedUrl", "isEmbedded", "metricGroup", "direction", "metric", "filters", "measure", "fixedTimespan", "apiLink", "shouldExcludeAlertSuppressionWindows", "_links", "type", "filter", "exclude", "dataSource"]

    @field_validator('type')
    def type_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^Test Table$", value):
            raise ValueError(r"must validate the regular expression /^Test Table$/")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "filter": ApiWidgetFilterApiTestTableFilterKey.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
            "exclude": ApiWidgetFilterApiTestTableFilterKey.from_dict(obj["exclude"]) if obj.get("exclude") is not None else None,
