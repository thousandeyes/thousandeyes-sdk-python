...
class ApiColorGridWidget(BaseModel):
    ...
    type: Annotated[str, Field(strict=True)] = Field(description="Color Grid widget type.")
    ...
    def type_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^Color Grid$", value):
            raise ValueError(r"must validate the regular expression /^Color Grid$/")
        return value
