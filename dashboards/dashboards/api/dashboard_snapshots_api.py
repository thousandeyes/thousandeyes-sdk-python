...
class DashboardSnapshotsApi:
    ...
    def create_dashboard_snapshot(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "CreateDashboardSnapshot201Response",
            '400': "ValidationError",
    ...
    def create_dashboard_snapshot_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateDashboardSnapshot201Response]:
        """Create dashboard snapshot
    ...
    def dashboard_snapshot_by_id(
        ...
        _param = self._dashboard_snapshot_by_id_serialize(
    ...
    @validate_call
    def dashboard_snapshot_by_id_with_http_info(
        self,
        snapshot_id: Annotated[StrictStr, Field(description="A Identifier for a dashboard snapshot which can be obtained from the `/dashboards-snapshots` endpoint.")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def dashboard_snapshot_by_id_without_preload_content(
        self,
        snapshot_id: Annotated[StrictStr, Field(description="A Identifier for a dashboard snapshot which can be obtained from the `/dashboards-snapshots` endpoint.")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    def _dashboard_snapshot_by_id_serialize(
        self,
        snapshot_id,
        aid,
        _request_auth,
    ...
    def dashboard_snapshots(
        ...
        _param = self._dashboard_snapshots_serialize(
            aid=aid,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DashboardSnapshots200Response",
            '400': "ValidationError",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
    ...
    @validate_call
    def dashboard_snapshots_with_http_info(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        dashboard_id: Optional[StrictStr] = None,
        cursor: Annotated[Optional[StrictStr], Field(description="(Optional) Opaque cursor used for pagination. Clients should use `next` value from `_links` instead of this parameter.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DashboardSnapshots200Response]:
        """List dashboard snapshots
    ...
    @validate_call
    def dashboard_snapshots_without_preload_content(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        dashboard_id: Optional[StrictStr] = None,
        cursor: Annotated[Optional[StrictStr], Field(description="(Optional) Opaque cursor used for pagination. Clients should use `next` value from `_links` instead of this parameter.")] = None,
    ...
    def _dashboard_snapshots_serialize(
        self,
        aid,
        dashboard_id,
        cursor,
    ...
    def snapshot_data_by_widget(
        ...
        _param = self._snapshot_data_by_widget_serialize(
            snapshot_id=snapshot_id,
            widget_id=widget_id,
            aid=aid,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SnapshotDataByWidget200Response",
            '400': "ValidationError",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
    ...
    @validate_call
    def snapshot_data_by_widget_with_http_info(
        self,
        snapshot_id: Annotated[StrictStr, Field(description="A Identifier for a dashboard snapshot which can be obtained from the `/dashboards-snapshots` endpoint.")],
        widget_id: Annotated[StrictStr, Field(description="A Identifier for a widget.")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SnapshotDataByWidget200Response]:
        """Retrieve dashboard snapshot data
    ...
    def _snapshot_data_by_widget_serialize(
        self,
        snapshot_id,
        widget_id,
        aid,
    ...
    @validate_call
    def update_snapshot_expiration_date(
        self,
        snapshot_id: Annotated[StrictStr, Field(description="A Identifier for a dashboard snapshot which can be obtained from the `/dashboards-snapshots` endpoint.")],
        ...
        _param = self._update_snapshot_expiration_date_serialize(
            snapshot_id=snapshot_id,
    ...
    @validate_call
    def update_snapshot_expiration_date_with_http_info(
        self,
        snapshot_id: Annotated[StrictStr, Field(description="A Identifier for a dashboard snapshot which can be obtained from the `/dashboards-snapshots` endpoint.")],
        update_snapshot_expiration_date_api_request: Annotated[UpdateSnapshotExpirationDateApiRequest, Field(description="Request body schema to update a snapshot expiration.")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
    ...
    def _update_snapshot_expiration_date_serialize(
        self,
        snapshot_id,
