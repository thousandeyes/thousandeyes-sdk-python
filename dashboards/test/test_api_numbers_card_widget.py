...
class TestApiNumbersCardWidget(unittest.TestCase):
    """ApiNumbersCardWidget unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiNumbersCardWidget:
        """Test ApiNumbersCardWidget
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiNumbersCardWidget`
        """
        model = ApiNumbersCardWidget()
        if include_optional:
            return ApiNumbersCardWidget(
                id = '1234',
                title = 'Widget Title',
                visual_mode = 'Full',
    ...
    def testApiNumbersCardWidget(self):
        """Test ApiNumbersCardWidget"""
