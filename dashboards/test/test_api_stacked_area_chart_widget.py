...
class TestApiStackedAreaChartWidget(unittest.TestCase):
    """ApiStackedAreaChartWidget unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiStackedAreaChartWidget:
        """Test ApiStackedAreaChartWidget
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiStackedAreaChartWidget`
        """
        model = ApiStackedAreaChartWidget()
        if include_optional:
            return ApiStackedAreaChartWidget(
                id = '1234',
                title = 'Widget Title',
                visual_mode = 'Full',
    ...
    def testApiStackedAreaChartWidget(self):
        """Test ApiStackedAreaChartWidget"""
