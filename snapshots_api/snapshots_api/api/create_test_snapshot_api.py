...
from snapshots_api.rest import RESTResponseType
...
class CreateTestSnapshotApi:
    ...
    def create_test_snapshot(
        ...
        :type test_id: str
        :param snapshot_request: (required)
        ...
        _param = self._create_test_snapshot_serialize(
            test_id=test_id,
    ...
    @validate_call
    def create_test_snapshot_with_http_info(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID.")],
        snapshot_request: SnapshotRequest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
    ...
    @validate_call
    def create_test_snapshot_without_preload_content(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID.")],
        snapshot_request: SnapshotRequest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
    ...
    def _create_test_snapshot_serialize(
        self,
        test_id,
        snapshot_request,
        aid,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v7/tests/{testId}/snapshot',
