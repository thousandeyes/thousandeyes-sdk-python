...
class DashboardApi:
    ...
    def create_dashboard_label(
        ...
        _param = self._create_dashboard_label_serialize(
            aid=aid,
    ...
    @validate_call
    def create_dashboard_label_with_http_info(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        label_request: Annotated[Optional[LabelRequest], Field(description="Label resource")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def create_dashboard_label_without_preload_content(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        label_request: Annotated[Optional[LabelRequest], Field(description="Label resource")] = None,
        _request_timeout: Union[
    ...
    def _create_dashboard_label_serialize(
        self,
        aid,
        label_request,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v7/labels/dashboard',
    ...
    def delete_dashboard_label(
        ...
        _param = self._delete_dashboard_label_serialize(
            label_id=label_id,
            aid=aid,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def delete_dashboard_label_with_http_info(
        self,
        label_id: Annotated[StrictStr, Field(description="ID of the label to get")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def delete_dashboard_label_without_preload_content(
        self,
        label_id: Annotated[StrictStr, Field(description="ID of the label to get")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    def _delete_dashboard_label_serialize(
        self,
        label_id,
        aid,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v7/labels/dashboard/{labelId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_dashboard_label(
        ...
        _param = self._get_dashboard_label_serialize(
            label_id=label_id,
            aid=aid,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_dashboard_label_with_http_info(
        self,
        label_id: Annotated[StrictStr, Field(description="ID of the label to get")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_dashboard_label_without_preload_content(
        self,
        label_id: Annotated[StrictStr, Field(description="ID of the label to get")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    def _get_dashboard_label_serialize(
        self,
        label_id,
        aid,
        _request_auth,
    ...
    def get_dashboard_labels(
        ...
        _param = self._get_dashboard_labels_serialize(
            aid=aid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_dashboard_labels_with_http_info(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_dashboard_labels_without_preload_content(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_dashboard_labels_serialize(
        self,
        aid,
        _request_auth,
        _content_type,
    ...
    def update_dashboard_label(
        ...
        _param = self._update_dashboard_label_serialize(
            label_id=label_id,
            aid=aid,
            label_request=label_request,
            _request_auth=_request_auth,
    ...
    @validate_call
    def update_dashboard_label_with_http_info(
        self,
        label_id: Annotated[StrictStr, Field(description="ID of the label to get")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        label_request: Optional[LabelRequest] = None,
    ...
    @validate_call
    def update_dashboard_label_without_preload_content(
        self,
        label_id: Annotated[StrictStr, Field(description="ID of the label to get")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        label_request: Optional[LabelRequest] = None,
    ...
    def _update_dashboard_label_serialize(
        self,
        label_id,
        aid,
        label_request,
