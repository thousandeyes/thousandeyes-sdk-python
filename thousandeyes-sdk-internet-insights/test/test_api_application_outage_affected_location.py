...
class TestApiApplicationOutageAffectedLocation(unittest.TestCase):
    """ApiApplicationOutageAffectedLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiApplicationOutageAffectedLocation:
        """Test ApiApplicationOutageAffectedLocation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiApplicationOutageAffectedLocation`
        """
        model = ApiApplicationOutageAffectedLocation()
        if include_optional:
            return ApiApplicationOutageAffectedLocation(
    ...
    def testApiApplicationOutageAffectedLocation(self):
        """Test ApiApplicationOutageAffectedLocation"""
