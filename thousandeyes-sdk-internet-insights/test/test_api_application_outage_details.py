    ...
    def make_instance(self, include_optional) -> ApiApplicationOutageDetails:
        ...
        if include_optional:
            return ApiApplicationOutageDetails(
                ...
                affected_locations = [
                    thousandeyes_sdk.internet_insights.models.api_application_outage_affected_location.ApiApplicationOutageAffectedLocation(
                        location = 'Chicago, Illinois, US', 
                        affected_servers = [
                            thousandeyes_sdk.internet_insights.models.api_application_outage_affected_server.ApiApplicationOutageAffectedServer(
                                domain = 'amazon.com', 
