...
class ApiCatalogProviderResponse(BaseModel):
    ...
    """ # noqa: E501
    providers: Optional[List[ApiCatalogProvider]] = Field(default=None, description="List of catalog providers.")
    links: Optional[SelfLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["providers", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "providers": [ApiCatalogProvider.from_dict(_item) for _item in obj["providers"]] if obj.get("providers") is not None else None,
