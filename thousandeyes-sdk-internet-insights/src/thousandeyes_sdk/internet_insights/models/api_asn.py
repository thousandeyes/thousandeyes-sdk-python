...
class ApiAsn(BaseModel):
    """
    ApiAsn
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ASN (Autonomous Systems Number)")
    name: Optional[StrictStr] = Field(default=None, description="ASN (Autonomous Systems Number) name")
