...
class SIPServerApi:
    ...
    @validate_call
    def create_sip_server_test(
        self,
        update_sip_server_test: UpdateSipServerTest,
        ...
        :param update_sip_server_test: (required)
        :type update_sip_server_test: UpdateSipServerTest
        ...
        _param = self._create_sip_server_test_serialize(
            update_sip_server_test=update_sip_server_test,
            aid=aid,
            expand=expand,
    ...
    @validate_call
    def create_sip_server_test_with_http_info(
        self,
        update_sip_server_test: UpdateSipServerTest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        expand: Annotated[Optional[List[Expand]], Field(description="Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.")] = None,
    ...
    @validate_call
    def create_sip_server_test_without_preload_content(
        self,
        update_sip_server_test: UpdateSipServerTest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        expand: Annotated[Optional[List[Expand]], Field(description="Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.")] = None,
    ...
    def _create_sip_server_test_serialize(
        self,
        ...
        if update_sip_server_test is not None:
            _body_params = update_sip_server_test
    ...
    def delete_sip_server_test(
        ...
        _param = self._delete_sip_server_test_serialize(
            test_id=test_id,
            aid=aid,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def delete_sip_server_test_with_http_info(
        self,
        test_id: Annotated[StrictStr, Field(description="ID of the test")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def delete_sip_server_test_without_preload_content(
        self,
        test_id: Annotated[StrictStr, Field(description="ID of the test")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    def _delete_sip_server_test_serialize(
        self,
        test_id,
        aid,
        _request_auth,
    ...
    def get_sip_server_test(
        ...
        _param = self._get_sip_server_test_serialize(
            test_id=test_id,
            aid=aid,
            expand=expand,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetSipServerTest200Response",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
            '429': "Error",
    ...
    @validate_call
    def get_sip_server_test_with_http_info(
        self,
        test_id: Annotated[StrictStr, Field(description="ID of the test")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        expand: Annotated[Optional[List[Expand]], Field(description="Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSipServerTest200Response]:
        """Get SIP Server test
    ...
    @validate_call
    def get_sip_server_test_without_preload_content(
        self,
        test_id: Annotated[StrictStr, Field(description="ID of the test")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        expand: Annotated[Optional[List[Expand]], Field(description="Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.")] = None,
    ...
    def _get_sip_server_test_serialize(
        self,
        test_id,
        aid,
        expand,
    ...
    def get_sip_server_tests(
        ...
        _param = self._get_sip_server_tests_serialize(
            aid=aid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetSipServerTests200Response",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
            '429': "Error",
    ...
    @validate_call
    def get_sip_server_tests_with_http_info(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSipServerTests200Response]:
        """List SIP Server tests
    ...
    @validate_call
    def get_sip_server_tests_without_preload_content(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_sip_server_tests_serialize(
        self,
        aid,
        _request_auth,
        _content_type,
    ...
    def update_sip_server_test(
        ...
        _param = self._update_sip_server_test_serialize(
            test_id=test_id,
            update_sip_server_test=update_sip_server_test,
            aid=aid,
            expand=expand,
    ...
    @validate_call
    def update_sip_server_test_with_http_info(
        self,
        test_id: Annotated[StrictStr, Field(description="ID of the test")],
        update_sip_server_test: UpdateSipServerTest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
    ...
    @validate_call
    def update_sip_server_test_without_preload_content(
        self,
        test_id: Annotated[StrictStr, Field(description="ID of the test")],
        update_sip_server_test: UpdateSipServerTest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
    ...
    def _update_sip_server_test_serialize(
        self,
        test_id,
        update_sip_server_test,
        aid,
