...
class DNSServerApi:
    ...
    def create_dns_server_test(
        ...
        :param update_dns_server_test: (required)
        :type update_dns_server_test: UpdateDnsServerTest
        ...
        _param = self._create_dns_server_test_serialize(
            update_dns_server_test=update_dns_server_test,
            aid=aid,
            expand=expand,
    ...
    def _create_dns_server_test_serialize(
        ...
        if update_dns_server_test is not None:
            _body_params = update_dns_server_test
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v7/tests/dns-server',
    ...
    def _delete_dns_server_test_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v7/tests/dns-server/{testId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_dns_server_test(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetDNSServerTest200Response",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
            '429': "Error",
    ...
    def get_dns_server_test_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetDNSServerTest200Response]:
        """Get DNS Server test
    ...
    def get_dns_server_tests(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetDNSServerTests200Response",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
            '429': "Error",
    ...
    def get_dns_server_tests_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetDNSServerTests200Response]:
        """List DNS Server tests
