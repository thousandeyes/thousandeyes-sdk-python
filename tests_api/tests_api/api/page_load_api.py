...
class PageLoadApi:
    ...
    def create_page_load_test(
        ...
        :param update_page_load_test: (required)
        :type update_page_load_test: UpdatePageLoadTest
        ...
        _param = self._create_page_load_test_serialize(
            update_page_load_test=update_page_load_test,
            aid=aid,
            expand=expand,
    ...
    def _create_page_load_test_serialize(
        ...
        if update_page_load_test is not None:
            _body_params = update_page_load_test
    ...
    def get_page_load_test(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetPageLoadTest200Response",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
            '429': "Error",
    ...
    def get_page_load_test_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetPageLoadTest200Response]:
        """Get Page Load test
    ...
    def get_page_load_tests(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetPageLoadTests200Response",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
            '429': "Error",
    ...
    def get_page_load_tests_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetPageLoadTests200Response]:
        """List Page Load tests
