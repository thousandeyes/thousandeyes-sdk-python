...
class DNSTraceApi:
    ...
    def create_dns_trace_test(
        self,
        update_dns_trace_test: UpdateDnsTraceTest,
        ...
        :param update_dns_trace_test: (required)
        :type update_dns_trace_test: UpdateDnsTraceTest
        ...
        _param = self._create_dns_trace_test_serialize(
            update_dns_trace_test=update_dns_trace_test,
            aid=aid,
            expand=expand,
    ...
    @validate_call
    def create_dns_trace_test_with_http_info(
        self,
        update_dns_trace_test: UpdateDnsTraceTest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        expand: Annotated[Optional[List[Expand]], Field(description="Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.")] = None,
    ...
    @validate_call
    def create_dns_trace_test_without_preload_content(
        self,
        update_dns_trace_test: UpdateDnsTraceTest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        expand: Annotated[Optional[List[Expand]], Field(description="Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.")] = None,
    ...
    def _create_dns_trace_test_serialize(
        self,
        ...
        if update_dns_trace_test is not None:
            _body_params = update_dns_trace_test
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v7/tests/dns-trace',
    ...
    def delete_dns_trace_test(
        ...
        _param = self._delete_dns_trace_test_serialize(
            test_id=test_id,
            aid=aid,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def delete_dns_trace_test_with_http_info(
        self,
        test_id: Annotated[StrictStr, Field(description="ID of the test")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def delete_dns_trace_test_without_preload_content(
        self,
        test_id: Annotated[StrictStr, Field(description="ID of the test")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    def _delete_dns_trace_test_serialize(
        self,
        test_id,
        aid,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v7/tests/dns-trace/{testId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_dns_trace_test(
        ...
        _param = self._get_dns_trace_test_serialize(
            test_id=test_id,
            aid=aid,
            expand=expand,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetDnsTraceTest200Response",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
            '429': "Error",
    ...
    @validate_call
    def get_dns_trace_test_with_http_info(
        self,
        test_id: Annotated[StrictStr, Field(description="ID of the test")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        expand: Annotated[Optional[List[Expand]], Field(description="Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetDnsTraceTest200Response]:
        """Get DNS Trace test
    ...
    @validate_call
    def get_dns_trace_test_without_preload_content(
        self,
        test_id: Annotated[StrictStr, Field(description="ID of the test")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        expand: Annotated[Optional[List[Expand]], Field(description="Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.")] = None,
    ...
    def _get_dns_trace_test_serialize(
        self,
        test_id,
        aid,
        expand,
    ...
    def get_dns_trace_tests(
        ...
        _param = self._get_dns_trace_tests_serialize(
            aid=aid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetDnsTraceTests200Response",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
            '429': "Error",
    ...
    @validate_call
    def get_dns_trace_tests_with_http_info(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetDnsTraceTests200Response]:
        """List DNS Trace tests
    ...
    @validate_call
    def get_dns_trace_tests_without_preload_content(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_dns_trace_tests_serialize(
        self,
        aid,
        _request_auth,
        _content_type,
    ...
    def update_dns_trace_test(
        ...
        _param = self._update_dns_trace_test_serialize(
            test_id=test_id,
            update_dns_trace_test=update_dns_trace_test,
            aid=aid,
            expand=expand,
    ...
    @validate_call
    def update_dns_trace_test_with_http_info(
        self,
        test_id: Annotated[StrictStr, Field(description="ID of the test")],
        update_dns_trace_test: UpdateDnsTraceTest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
    ...
    @validate_call
    def update_dns_trace_test_without_preload_content(
        self,
        test_id: Annotated[StrictStr, Field(description="ID of the test")],
        update_dns_trace_test: UpdateDnsTraceTest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
    ...
    def _update_dns_trace_test_serialize(
        self,
        test_id,
        update_dns_trace_test,
        aid,
