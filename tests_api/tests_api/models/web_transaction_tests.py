...
class WebTransactionTests(BaseModel):
    """
    WebTransactionTests
    """ # noqa: E501
    tests: Optional[List[WebTransactionTest]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "tests": [WebTransactionTest.from_dict(_item) for _item in obj.get("tests")] if obj.get("tests") is not None else None
        })
        return _obj
