...
class GetHttpServerTests200Response(BaseModel):
    """
    GetHttpServerTests200Response
    """ # noqa: E501
    tests: Optional[List[HttpServerTest]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "tests": [HttpServerTest.from_dict(_item) for _item in obj.get("tests")] if obj.get("tests") is not None else None,
