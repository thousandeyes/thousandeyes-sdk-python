...
class UpdateHttpServerTest(BaseModel):
    ...
    agents: List[TestRequestAllOfAgents] = Field(description="Contains list of object with required `agentId` and optional `sourceIpAddress`")
    ...
    __properties: ClassVar[List[str]] = ["interval", "alertsEnabled", "enabled", "alertRules", "createdBy", "createdDate", "description", "liveShare", "modifiedBy", "modifiedDate", "savedEvent", "testId", "testName", "type", "_links", "labels", "sharedWithAccounts", "agents", "authType", "bandwidthMeasurements", "clientCertificate", "contentRegex", "headers", "customHeaders", "desiredStatusCode", "downloadLimit", "dnsOverride", "httpTargetTime", "httpTimeLimit", "httpVersion", "includeHeaders", "mtuMeasurements", "networkMeasurements", "numPathTraces", "password", "pathTraceMode", "postBody", "probeMode", "protocol", "sslVersion", "sslVersionId", "url", "useNtlm", "userAgent", "username", "verifyCertificate", "ipv6Policy", "followRedirects", "fixedPacketRate", "bgpMeasurements", "monitors"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "agents": [TestRequestAllOfAgents.from_dict(_item) for _item in obj.get("agents")] if obj.get("agents") is not None else None,
