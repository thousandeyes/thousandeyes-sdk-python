...
class TestLabelsInner(BaseModel):
    """
    TestLabelsInner
    """ # noqa: E501
    ...
    is_built_in: Optional[StrictBool] = Field(default=None, description="Value indicating if the label in question is BuiltIn (Account Admin, Organization Admin, Regular User).", alias="isBuiltIn")
