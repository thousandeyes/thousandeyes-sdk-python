...
with tests_api.ApiClient(configuration) as api_client:
    ...
    api_instance = tests_api.AgentToServerApi(api_client)
    update_agent_to_server_test = tests_api.UpdateAgentToServerTest() # UpdateAgentToServerTest | 
...
> GetAgentToServerTest200Response get_agent_to_server_test(test_id, aid=aid, expand=expand)
...
> GetAgentToServerTest200Response update_agent_to_server_test(test_id, update_agent_to_server_test, aid=aid, expand=expand)
