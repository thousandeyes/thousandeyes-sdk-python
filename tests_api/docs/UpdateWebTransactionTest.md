...
**target_time** | **int** | Target time for completion, defaults to 50% of time limit specified in seconds. | [optional] 
...
json = "{}"
# create an instance of UpdateWebTransactionTest from a JSON string
update_web_transaction_test_instance = UpdateWebTransactionTest.from_json(json)
# print the JSON string representation of the object
print UpdateWebTransactionTest.to_json()

# convert the object into a dict
update_web_transaction_test_dict = update_web_transaction_test_instance.to_dict()
# create an instance of UpdateWebTransactionTest from a dict
update_web_transaction_test_form_dict = update_web_transaction_test.from_dict(update_web_transaction_test_dict)
```
