...
json = "{}"
# create an instance of GetPageLoadTest200Response from a JSON string
get_page_load_test200_response_instance = GetPageLoadTest200Response.from_json(json)
# print the JSON string representation of the object
print GetPageLoadTest200Response.to_json()

# convert the object into a dict
get_page_load_test200_response_dict = get_page_load_test200_response_instance.to_dict()
# create an instance of GetPageLoadTest200Response from a dict
get_page_load_test200_response_form_dict = get_page_load_test200_response.from_dict(get_page_load_test200_response_dict)
```
