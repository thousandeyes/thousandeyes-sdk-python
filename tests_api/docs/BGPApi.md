...
with tests_api.ApiClient(configuration) as api_client:
    ...
    api_instance = tests_api.BGPApi(api_client)
    update_bgp_test = tests_api.UpdateBgpTest() # UpdateBgpTest | 
...
# **get_bgp_test**
> GetBgpTest200Response get_bgp_test(test_id, aid=aid, expand=expand)
...
# **get_bgp_tests**
> GetBgpTests200Response get_bgp_tests(aid=aid)
...
# **update_bgp_test**
> GetBgpTest200Response update_bgp_test(test_id, update_bgp_test, aid=aid, expand=expand)
...
with tests_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Update BGP test
        api_response = api_instance.update_bgp_test(test_id, update_bgp_test, aid=aid, expand=expand)
