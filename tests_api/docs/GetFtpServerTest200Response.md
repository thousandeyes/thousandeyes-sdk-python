...
json = "{}"
# create an instance of GetFtpServerTest200Response from a JSON string
get_ftp_server_test200_response_instance = GetFtpServerTest200Response.from_json(json)
# print the JSON string representation of the object
print GetFtpServerTest200Response.to_json()

# convert the object into a dict
get_ftp_server_test200_response_dict = get_ftp_server_test200_response_instance.to_dict()
# create an instance of GetFtpServerTest200Response from a dict
get_ftp_server_test200_response_form_dict = get_ftp_server_test200_response.from_dict(get_ftp_server_test200_response_dict)
```
