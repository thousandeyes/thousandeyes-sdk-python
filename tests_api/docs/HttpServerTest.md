...
json = "{}"
# create an instance of HttpServerTest from a JSON string
http_server_test_instance = HttpServerTest.from_json(json)
# print the JSON string representation of the object
print HttpServerTest.to_json()

# convert the object into a dict
http_server_test_dict = http_server_test_instance.to_dict()
# create an instance of HttpServerTest from a dict
http_server_test_form_dict = http_server_test.from_dict(http_server_test_dict)
```
