...
json = "{}"
# create an instance of UpdateDnsSecTest from a JSON string
update_dns_sec_test_instance = UpdateDnsSecTest.from_json(json)
# print the JSON string representation of the object
print UpdateDnsSecTest.to_json()

# convert the object into a dict
update_dns_sec_test_dict = update_dns_sec_test_instance.to_dict()
# create an instance of UpdateDnsSecTest from a dict
update_dns_sec_test_form_dict = update_dns_sec_test.from_dict(update_dns_sec_test_dict)
```
