...
json = "{}"
# create an instance of AgentToServerTest from a JSON string
agent_to_server_test_instance = AgentToServerTest.from_json(json)
# print the JSON string representation of the object
print AgentToServerTest.to_json()

# convert the object into a dict
agent_to_server_test_dict = agent_to_server_test_instance.to_dict()
# create an instance of AgentToServerTest from a dict
agent_to_server_test_form_dict = agent_to_server_test.from_dict(agent_to_server_test_dict)
```
