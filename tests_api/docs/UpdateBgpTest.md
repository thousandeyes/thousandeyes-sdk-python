...
update_bgp_test_instance = UpdateBgpTest.from_json(json)
# print the JSON string representation of the object
print UpdateBgpTest.to_json()

# convert the object into a dict
update_bgp_test_dict = update_bgp_test_instance.to_dict()
# create an instance of UpdateBgpTest from a dict
update_bgp_test_form_dict = update_bgp_test.from_dict(update_bgp_test_dict)
```
