...
class EndpointAgentsConnectionString200Response(BaseModel):
    """
    EndpointAgentsConnectionString200Response
    """ # noqa: E501
    links: Optional[SelfLinksLinks] = Field(default=None, alias="_links")
    connection_string: Optional[StrictStr] = Field(default=None, description="The connection string is used for some integrations and other client types. ", alias="connectionString")
    __properties: ClassVar[List[str]] = ["_links", "connectionString"]
