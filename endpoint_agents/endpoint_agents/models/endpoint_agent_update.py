...
class EndpointAgentUpdate(BaseModel):
    ...
    license_type: Optional[Any] = Field(default=None, alias="licenseType")
    __properties: ClassVar[List[str]] = ["name", "licenseType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "licenseType": AgentLicenseType.from_dict(obj["licenseType"]) if obj.get("licenseType") is not None else None
        })
        return _obj
