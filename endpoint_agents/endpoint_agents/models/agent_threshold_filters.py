...
class AgentThresholdFilters(BaseModel):
    """
    All filters are applied based on the conditional operator (and/or).
    """ # noqa: E501
    filters: Optional[List[AgentThresholdFilter]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filters": [AgentThresholdFilter.from_dict(_item) for _item in obj["filters"]] if obj.get("filters") is not None else None,
