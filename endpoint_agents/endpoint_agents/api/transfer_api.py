...
class TransferApi:
    ...
    def endpoint_agent_bulk_transfer(
        ...
        agent_transfers: Annotated[Optional[AgentTransfers], Field(description="A collection of `AgentTransfers`.")] = None,
        ...
        :type aid: str
        :param agent_transfers: A collection of `AgentTransfers`.
        :type agent_transfers: AgentTransfers
