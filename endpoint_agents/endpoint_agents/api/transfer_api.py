...
from endpoint_agents.api_client import ApiClient, RequestSerialized
from endpoint_agents.api_response import ApiResponse
from endpoint_agents.rest import RESTResponseType
...
class TransferApi:
    ...
    @validate_call
    def endpoint_agent_bulk_transfer(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        endpoint_agent_bulk_transfer_request: Annotated[Optional[EndpointAgentBulkTransferRequest], Field(description="A collection of `AgentTransfers`.")] = None,
        ...
        :type aid: str
        :param endpoint_agent_bulk_transfer_request: A collection of `AgentTransfers`.
        :type endpoint_agent_bulk_transfer_request: EndpointAgentBulkTransferRequest
        ...
        _param = self._endpoint_agent_bulk_transfer_serialize(
            aid=aid,
            endpoint_agent_bulk_transfer_request=endpoint_agent_bulk_transfer_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '207': "EndpointAgentBulkTransfer207Response",
            '400': "ValidationError",
    ...
    @validate_call
    def endpoint_agent_bulk_transfer_with_http_info(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        endpoint_agent_bulk_transfer_request: Annotated[Optional[EndpointAgentBulkTransferRequest], Field(description="A collection of `AgentTransfers`.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EndpointAgentBulkTransfer207Response]:
        """Bulk transfer agents
    ...
    @validate_call
    def endpoint_agent_bulk_transfer_without_preload_content(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        endpoint_agent_bulk_transfer_request: Annotated[Optional[EndpointAgentBulkTransferRequest], Field(description="A collection of `AgentTransfers`.")] = None,
        _request_timeout: Union[
    ...
    def _endpoint_agent_bulk_transfer_serialize(
        self,
        aid,
        endpoint_agent_bulk_transfer_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if endpoint_agent_bulk_transfer_request is not None:
            _body_params = endpoint_agent_bulk_transfer_request
    ...
    @validate_call
    def endpoint_agent_single_transfer(
        self,
        ...
        _param = self._endpoint_agent_single_transfer_serialize(
            agent_id=agent_id,
    ...
    @validate_call
    def endpoint_agent_single_transfer_with_http_info(
        self,
        agent_id: Annotated[StrictStr, Field(description="The identifier of the agent to operate on.")],
        agent_transfer_request: Annotated[AgentTransferRequest, Field(description="The request to move an agent between accounts.")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
    ...
    @validate_call
    def endpoint_agent_single_transfer_without_preload_content(
        self,
        agent_id: Annotated[StrictStr, Field(description="The identifier of the agent to operate on.")],
        agent_transfer_request: Annotated[AgentTransferRequest, Field(description="The request to move an agent between accounts.")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
    ...
    def _endpoint_agent_single_transfer_serialize(
        self,
        agent_id,
