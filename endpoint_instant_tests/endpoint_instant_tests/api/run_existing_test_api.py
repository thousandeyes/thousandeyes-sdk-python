...
class RunExistingTestApi:
    ...
    def post_endpoint_instant_run(
        ...
        _param = self._post_endpoint_instant_run_serialize(
            test_id=test_id,
            aid=aid,
    ...
    @validate_call
    def post_endpoint_instant_run_with_http_info(
        self,
        test_id: Annotated[StrictStr, Field(description="ID of the endpoint instant scheduled test to rerun")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    def _post_endpoint_instant_run_serialize(
        self,
        test_id,
        aid,
        _request_auth,
