    ...
    def make_instance(self, include_optional) -> EndpointScheduledTest:
        ...
        if include_optional:
            return EndpointScheduledTest(
                aid = '1234',
                links = thousandeyes_sdk.endpoint_test_results.models.endpoint_test_links.EndpointTestLinks(
                    self = null, 
                ...
                tcp_probe_mode = 'auto',
                alert_rules = [
                    thousandeyes_sdk.endpoint_test_results.models.alert_rule.AlertRule(
                        rule_id = '127094', 
