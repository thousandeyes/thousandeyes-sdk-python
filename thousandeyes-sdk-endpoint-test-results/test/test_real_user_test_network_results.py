...
class TestRealUserTestNetworkResults(unittest.TestCase):
    """RealUserTestNetworkResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RealUserTestNetworkResults:
        ...
        # uncomment below to create an instance of `RealUserTestNetworkResults`
        """
        model = RealUserTestNetworkResults()
        if include_optional:
            return RealUserTestNetworkResults(
                results = [
                    thousandeyes_sdk.endpoint_test_results.models.real_user_test_network_result.RealUserTestNetworkResult(
    ...
    def testRealUserTestNetworkResults(self):
        """Test RealUserTestNetworkResults"""
