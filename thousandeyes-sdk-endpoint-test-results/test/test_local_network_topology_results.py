...
class TestLocalNetworkTopologyResults(unittest.TestCase):
    """LocalNetworkTopologyResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalNetworkTopologyResults:
        """Test LocalNetworkTopologyResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalNetworkTopologyResults`
        """
        model = LocalNetworkTopologyResults()
        if include_optional:
            return LocalNetworkTopologyResults(
                results = [
                    thousandeyes_sdk.endpoint_test_results.models.local_network_topology_result_base.LocalNetworkTopologyResultBase(
    ...
    def testLocalNetworkTopologyResults(self):
        """Test LocalNetworkTopologyResults"""
