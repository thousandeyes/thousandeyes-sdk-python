...
class WebHTTPServerScheduledTestResultsApi:
    ...
    def get_multi_test_filtered_http_server_scheduled_test_results(
        ...
        cursor: Annotated[Optional[StrictStr], Field(description="(Optional) Opaque cursor used for pagination. Clients should use `next` value from `_links` instead of this parameter.")] = None,
        expand: Annotated[Optional[List[Expand]], Field(description="This parameter is optional and determines whether to expand resources related to test results. By default, no expansion occurs when this query parameter is omitted. To expand a specific resource, such as \"header,\" append `?expand=header` to the query.")] = None,
        http_tests_data_rounds_search: Annotated[Optional[HttpTestsDataRoundsSearch], Field(description="Test data search filters.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param expand: This parameter is optional and determines whether to expand resources related to test results. By default, no expansion occurs when this query parameter is omitted. To expand a specific resource, such as \"header,\" append `?expand=header` to the query.
        :type expand: List[Expand]
        :param http_tests_data_rounds_search: Test data search filters.
        :type http_tests_data_rounds_search: HttpTestsDataRoundsSearch
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_multi_test_filtered_http_server_scheduled_test_results_serialize(
            ...
            cursor=cursor,
            expand=expand,
            http_tests_data_rounds_search=http_tests_data_rounds_search,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def get_multi_test_filtered_http_server_scheduled_test_results_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[HttpMultiTestResults]:
        """Filter HTTP server scheduled test results
    ...
    def _get_multi_test_filtered_http_server_scheduled_test_results_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if http_tests_data_rounds_search is not None:
            _body_params = http_tests_data_rounds_search
