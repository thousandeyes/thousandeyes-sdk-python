...
class NetworkDynamicTestsResultsApi:
    ...
    def get_dynamic_test_result_network_pathvis_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PathVisDynamicTestResults]:
        """Retrieve path visualization network dynamic test results
    ...
    def get_dynamic_test_result_pathvis_agent_round(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PathVisDetailDynamicTestResults",
            '400': "ValidationError",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
    ...
    def get_dynamic_test_result_pathvis_agent_round_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PathVisDetailDynamicTestResults]:
        """Retrieve path visualization network dynamic test results details
    ...
    def post_fetch_dynamic_test_result_metrics_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NetworkDynamicTestResults]:
        """Retrieve network dynamic test results
