...
class DynamicEndpointTestsDataRoundSearch(BaseModel):
    """
    ...
    search_filters: Optional[DynamicEndpointTestsDataSearchFilter] = Field(default=None, alias="searchFilters")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "searchFilters": DynamicEndpointTestsDataSearchFilter.from_dict(obj["searchFilters"]) if obj.get("searchFilters") is not None else None
        })
        return _obj
