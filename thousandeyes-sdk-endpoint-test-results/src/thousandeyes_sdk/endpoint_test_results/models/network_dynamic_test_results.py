...
class NetworkDynamicTestResults(BaseModel):
    """
    NetworkDynamicTestResults
    """ # noqa: E501
    results: Optional[List[NetworkDynamicTestResult]] = None
    test: Optional[DynamicTest] = None
    total_hits: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total number of measurements that match the search criteria", alias="totalHits")
    ...
    __properties: ClassVar[List[str]] = ["results", "test", "totalHits", "startDate", "endDate", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [NetworkDynamicTestResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
