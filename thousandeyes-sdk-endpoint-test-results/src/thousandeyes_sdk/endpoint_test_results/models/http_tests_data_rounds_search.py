...
class HttpTestsDataRoundsSearch(BaseModel):
    """
    HttpTestsDataRoundsSearch
    """ # noqa: E501
    search_sort: Optional[List[HttpTestsDataSearchSort]] = Field(default=None, alias="searchSort")
    threshold_filter: Optional[HttpTestsDataThresholdFilters] = Field(default=None, alias="thresholdFilter")
    search_filters: Optional[HttpTestsDataSearchFilter] = Field(default=None, alias="searchFilters")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "searchSort": [HttpTestsDataSearchSort.from_dict(_item) for _item in obj["searchSort"]] if obj.get("searchSort") is not None else None,
            "thresholdFilter": HttpTestsDataThresholdFilters.from_dict(obj["thresholdFilter"]) if obj.get("thresholdFilter") is not None else None,
            "searchFilters": HttpTestsDataSearchFilter.from_dict(obj["searchFilters"]) if obj.get("searchFilters") is not None else None
        })
        return _obj
