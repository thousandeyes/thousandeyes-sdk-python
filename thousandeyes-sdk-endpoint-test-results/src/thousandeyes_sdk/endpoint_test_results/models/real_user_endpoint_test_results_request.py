...
class RealUserEndpointTestResultsRequest(BaseModel):
    """
    RealUserEndpointTestResultsRequest
    """ # noqa: E501
    search_filters: Optional[RealUserEndpointTestResultRequestFilter] = Field(default=None, alias="searchFilters")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "searchFilters": RealUserEndpointTestResultRequestFilter.from_dict(obj["searchFilters"]) if obj.get("searchFilters") is not None else None
        })
        return _obj
