...
class LocalNetworkTopologyDnsServerTest(BaseModel):
    """
    DNS server test details. This object is only available when the topology `type` is `dns`.
    """ # noqa: E501
    resolution_time: Optional[StrictInt] = Field(default=None, description="How long it took to resolve the DNS query in milliseconds.", alias="resolutionTime")
    __properties: ClassVar[List[str]] = ["resolutionTime"]
