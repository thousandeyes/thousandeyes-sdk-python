...
class HttpEndpointTestResult(BaseModel):
    """
    ...
    headers: Optional[HttpEndpointTestResultHeaders] = None
    ...
    __properties: ClassVar[List[str]] = ["aid", "agentId", "roundId", "serverIp", "networkProfile", "systemMetrics", "originalTargetProfile", "vpnProfile", "connectTime", "dnsTime", "errorType", "errorDetails", "headers", "numRedirects", "receiveTime", "redirectTime", "responseCode", "responseTime", "sslTime", "totalTime", "waitTime", "wireSize"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "headers": HttpEndpointTestResultHeaders.from_dict(obj["headers"]) if obj.get("headers") is not None else None,
