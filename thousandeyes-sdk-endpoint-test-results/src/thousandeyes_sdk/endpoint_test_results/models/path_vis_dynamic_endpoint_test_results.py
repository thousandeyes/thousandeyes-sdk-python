...
class PathVisDynamicEndpointTestResults(BaseModel):
    """
    PathVisDynamicEndpointTestResults
    """ # noqa: E501
    results: Optional[List[PathVisDynamicEndpointTestResult]] = None
    ...
    __properties: ClassVar[List[str]] = ["results", "test", "startDate", "endDate", "totalHits", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [PathVisDynamicEndpointTestResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
