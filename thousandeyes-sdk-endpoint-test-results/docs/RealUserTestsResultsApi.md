...
> EndpointRealUserTestDetailResults get_endpoint_real_user_test_details(id, aid=aid)
...
> RealUserTestPageDetailResult get_endpoint_real_user_test_pages_details(id, page_id, aid=aid)
...
> EndpointRealUserTestResults get_endpoint_real_user_tests(aid=aid, window=window, start_date=start_date, end_date=end_date, cursor=cursor, endpoint_real_user_test_results_request=endpoint_real_user_test_results_request)
...
> RealUserTestNetworkResults get_endpoint_real_user_tests_network(aid=aid, window=window, start_date=start_date, end_date=end_date, cursor=cursor, endpoint_real_user_test_results_request=endpoint_real_user_test_results_request)
...
> RealUserTestPageResults get_endpoint_real_user_tests_pages(aid=aid, window=window, start_date=start_date, end_date=end_date, cursor=cursor, endpoint_real_user_test_result_request_filter=endpoint_real_user_test_result_request_filter)
