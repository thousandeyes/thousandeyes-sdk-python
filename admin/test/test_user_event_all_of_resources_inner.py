...
class TestUserEventAllOfResourcesInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UserEventAllOfResourcesInner:
        """Test UserEventAllOfResourcesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserEventAllOfResourcesInner`
        """
        model = UserEventAllOfResourcesInner()
        if include_optional:
            return UserEventAllOfResourcesInner(
                type = '',
                name = ''
            )
        else:
    ...
    def testUserEventAllOfResourcesInner(self):
        """Test UserEventAllOfResourcesInner"""
