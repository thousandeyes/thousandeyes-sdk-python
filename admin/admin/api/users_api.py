...
class UsersApi:
    ...
    def create_user(
        self,
        user_request_body: UserRequestBody,
        ...
        :param user_request_body: (required)
        :type user_request_body: UserRequestBody
    ...
    def _create_user_serialize(
        ...
        if user_request_body is not None:
            _body_params = user_request_body
