...
class TestApiAffectedAgent(unittest.TestCase):
    """ApiAffectedAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiAffectedAgent:
        """Test ApiAffectedAgent
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiAffectedAgent`
        """
        model = ApiAffectedAgent()
        if include_optional:
            return ApiAffectedAgent(
                id = 11,
                name = 'London, England'
            )
        else:
