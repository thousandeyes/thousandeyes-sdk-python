...
class TestApiApplicationOutageAffectedServer(unittest.TestCase):
    """ApiApplicationOutageAffectedServer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiApplicationOutageAffectedServer:
        """Test ApiApplicationOutageAffectedServer
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiApplicationOutageAffectedServer`
        """
        model = ApiApplicationOutageAffectedServer()
        if include_optional:
            return ApiApplicationOutageAffectedServer(
                domain = 'amazon.com',
    ...
    def testApiApplicationOutageAffectedServer(self):
        """Test ApiApplicationOutageAffectedServer"""
