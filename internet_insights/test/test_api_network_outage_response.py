...
class TestApiNetworkOutageResponse(unittest.TestCase):
    """ApiNetworkOutageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiNetworkOutageResponse:
        """Test ApiNetworkOutageResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiNetworkOutageResponse`
        """
        model = ApiNetworkOutageResponse()
        if include_optional:
            return ApiNetworkOutageResponse(
                ...
                affected_locations = [
                    internet_insights.models.api_network_outage_affected_location.ApiNetworkOutageAffectedLocation(
    ...
    def testApiNetworkOutageResponse(self):
        """Test ApiNetworkOutageResponse"""
