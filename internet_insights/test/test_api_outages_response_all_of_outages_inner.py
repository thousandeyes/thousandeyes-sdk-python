...
class TestApiOutagesResponseAllOfOutagesInner(unittest.TestCase):
    """ApiOutagesResponseAllOfOutagesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiOutagesResponseAllOfOutagesInner:
        """Test ApiOutagesResponseAllOfOutagesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiOutagesResponseAllOfOutagesInner`
        """
        model = ApiOutagesResponseAllOfOutagesInner()
        if include_optional:
            return ApiOutagesResponseAllOfOutagesInner(
                id = 'xxxxxxxxxxxxxxxxxx1',
                type = 'app',
                provider_name = 'Google',
                provider_type = 'SAAS',
                name = 'Google',
                start_date = '2022-03-01T23:31:11Z',
                start_round_id = 1646177400,
                end_date = '2022-03-01T23:31:11Z',
                end_round_id = 1646177700,
                duration = 214,
                affected_tests_count = 1,
                affected_servers_count = 2,
                affected_locations_count = 1,
                affected_interfaces_count = 1,
                asn = 19994,
    ...
    def testApiOutagesResponseAllOfOutagesInner(self):
        """Test ApiOutagesResponseAllOfOutagesInner"""
