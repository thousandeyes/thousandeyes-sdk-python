...
class TestApiCatalogProviderFilter(unittest.TestCase):
    """ApiCatalogProviderFilter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiCatalogProviderFilter:
        """Test ApiCatalogProviderFilter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiCatalogProviderFilter`
        """
        model = ApiCatalogProviderFilter()
        if include_optional:
    ...
    def testApiCatalogProviderFilter(self):
        """Test ApiCatalogProviderFilter"""
