...
class TestApiNetworkOutageAffectedLocation(unittest.TestCase):
    """ApiNetworkOutageAffectedLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiNetworkOutageAffectedLocation:
        """Test ApiNetworkOutageAffectedLocation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiNetworkOutageAffectedLocation`
        """
        model = ApiNetworkOutageAffectedLocation()
        if include_optional:
            return ApiNetworkOutageAffectedLocation(
    ...
    def testApiNetworkOutageAffectedLocation(self):
        """Test ApiNetworkOutageAffectedLocation"""
