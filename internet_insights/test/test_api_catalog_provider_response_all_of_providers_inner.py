...
class TestApiCatalogProviderResponseAllOfProvidersInner(unittest.TestCase):
    """ApiCatalogProviderResponseAllOfProvidersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiCatalogProviderResponseAllOfProvidersInner:
        """Test ApiCatalogProviderResponseAllOfProvidersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiCatalogProviderResponseAllOfProvidersInner`
        """
        model = ApiCatalogProviderResponseAllOfProvidersInner()
        if include_optional:
            return ApiCatalogProviderResponseAllOfProvidersInner(
    ...
    def testApiCatalogProviderResponseAllOfProvidersInner(self):
        """Test ApiCatalogProviderResponseAllOfProvidersInner"""
