...
class TestApiCatalogProviderDetailsLocationsInner(unittest.TestCase):
    """ApiCatalogProviderDetailsLocationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiCatalogProviderDetailsLocationsInner:
        """Test ApiCatalogProviderDetailsLocationsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiCatalogProviderDetailsLocationsInner`
        """
        model = ApiCatalogProviderDetailsLocationsInner()
        if include_optional:
            return ApiCatalogProviderDetailsLocationsInner(
    ...
    def testApiCatalogProviderDetailsLocationsInner(self):
        """Test ApiCatalogProviderDetailsLocationsInner"""
