...
class TestApiOutage(unittest.TestCase):
    """ApiOutage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiOutage:
        """Test ApiOutage
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiOutage`
        """
        model = ApiOutage()
        if include_optional:
            return ApiOutage(
