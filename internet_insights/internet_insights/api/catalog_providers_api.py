...
class CatalogProvidersApi:
    ...
    def catalog_provider_list(
        ...
        _param = self._catalog_provider_list_serialize(
    ...
    @validate_call
    def catalog_provider_list_with_http_info(
        self,
        api_catalog_provider_filter: ApiCatalogProviderFilter,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def catalog_provider_list_without_preload_content(
        self,
        api_catalog_provider_filter: ApiCatalogProviderFilter,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    def _catalog_provider_list_serialize(
        self,
    ...
    def get_catalog_provider(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApiCatalogProviderDetailsResponse",
            '400': "ValidationError",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
    ...
    def get_catalog_provider_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApiCatalogProviderDetailsResponse]:
        """Retrieve a catalog provider
