...
from internet_insights.api_client import ApiClient, RequestSerialized
from internet_insights.api_response import ApiResponse
from internet_insights.rest import RESTResponseType
...
class OutagesAPIPublicApi:
    ...
    def get_outages_app(
        ...
        _param = self._get_outages_app_serialize(
            outage_id=outage_id,
            aid=aid,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApiApplicationOutageResponse",
            '400': "ValidationError",
    ...
    @validate_call
    def get_outages_app_with_http_info(
        self,
        outage_id: StrictStr,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApiApplicationOutageResponse]:
        """Retrieve application outage
    ...
    @validate_call
    def get_outages_app_without_preload_content(
        self,
        outage_id: StrictStr,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    def _get_outages_app_serialize(
        self,
        outage_id,
        aid,
        _request_auth,
    ...
    def get_outages_filter(
        ...
        _param = self._get_outages_filter_serialize(
    ...
    @validate_call
    def get_outages_filter_with_http_info(
        self,
        api_outage_filter: ApiOutageFilter,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_outages_filter_without_preload_content(
        self,
        api_outage_filter: ApiOutageFilter,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    def _get_outages_filter_serialize(
        self,
        api_outage_filter,
        aid,
        _request_auth,
    ...
    def get_outages_net(
        ...
        _param = self._get_outages_net_serialize(
            outage_id=outage_id,
            aid=aid,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_outages_net_with_http_info(
        self,
        outage_id: StrictStr,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApiNetworkOutageResponse]:
        """Retrieve network outage
    ...
    @validate_call
    def get_outages_net_without_preload_content(
        self,
        outage_id: StrictStr,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    def _get_outages_net_serialize(
        self,
        outage_id,
        aid,
        _request_auth,
