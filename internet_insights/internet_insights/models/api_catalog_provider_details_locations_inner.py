...
class ApiCatalogProviderDetailsLocationsInner(BaseModel):
    """
    ApiCatalogProviderDetailsLocationsInner
    """ # noqa: E501
    location: Optional[StrictStr] = Field(default=None, description="The location covered by the Provider.")
    interfaces_count: Optional[StrictInt] = Field(default=None, description="The number of interfaces covered by the Provider at this location.", alias="interfacesCount")
    __properties: ClassVar[List[str]] = ["location", "interfacesCount"]
