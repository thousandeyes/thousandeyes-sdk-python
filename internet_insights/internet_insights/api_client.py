...
from internet_insights.api_response import ApiResponse, T as ApiResponseT
import internet_insights.models
from internet_insights import rest
from internet_insights.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(internet_insights.models, klass)
