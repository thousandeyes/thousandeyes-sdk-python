...
class UsageApi:
    ...
    def get_enterprise_agents_units_usage(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetEnterpriseAgentsUnitsUsage200Response",
            '400': "ValidationError",
    ...
    def get_enterprise_agents_units_usage_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetEnterpriseAgentsUnitsUsage200Response]:
        """Get enterprise agent usage
    ...
    def _get_enterprise_agents_units_usage_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v7/usage/units/enterprise-agents',
    ...
    def get_test_units_usage(
        ...
        _param = self._get_test_units_usage_serialize(
            aid=aid,
            start_date=start_date,
            end_date=end_date,
            cursor=cursor,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetTestUnitsUsage200Response",
            '400': "ValidationError",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
    ...
    @validate_call
    def get_test_units_usage_with_http_info(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        start_date: Annotated[Optional[datetime], Field(description="Use with the `endDate` parameter. Include the complete time (hours, minutes, and seconds) in UTC time zone, following the ISO 8601 date-time format. See the example for reference. Please note that this parameter can't be used with `window`.")] = None,
        end_date: Annotated[Optional[datetime], Field(description="Defaults to current time the request is made. Use with the `startDate` parameter. Include the complete time (hours, minutes, and seconds) in UTC time zone, following the ISO 8601 date-time format. See the example for reference. Please note that this parameter can't be used with `window`.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetTestUnitsUsage200Response]:
        """Get cloud and enterprise agents units usage
    ...
    @validate_call
    def get_test_units_usage_without_preload_content(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        start_date: Annotated[Optional[datetime], Field(description="Use with the `endDate` parameter. Include the complete time (hours, minutes, and seconds) in UTC time zone, following the ISO 8601 date-time format. See the example for reference. Please note that this parameter can't be used with `window`.")] = None,
        end_date: Annotated[Optional[datetime], Field(description="Defaults to current time the request is made. Use with the `startDate` parameter. Include the complete time (hours, minutes, and seconds) in UTC time zone, following the ISO 8601 date-time format. See the example for reference. Please note that this parameter can't be used with `window`.")] = None,
    ...
    def _get_test_units_usage_serialize(
        self,
        aid,
        start_date,
        end_date,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v7/usage/units/tests',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
