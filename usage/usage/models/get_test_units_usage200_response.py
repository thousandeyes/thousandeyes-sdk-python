...
class GetTestUnitsUsage200Response(BaseModel):
    """
    GetTestUnitsUsage200Response
    """ # noqa: E501
    breakdowns: Optional[List[UnitsByTestsBreakdownsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "breakdowns": [UnitsByTestsBreakdownsInner.from_dict(_item) for _item in obj["breakdowns"]] if obj.get("breakdowns") is not None else None,
