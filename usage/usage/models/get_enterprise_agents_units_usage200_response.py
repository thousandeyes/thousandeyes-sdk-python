...
class GetEnterpriseAgentsUnitsUsage200Response(BaseModel):
    """
    GetEnterpriseAgentsUnitsUsage200Response
    """ # noqa: E501
    breakdowns: Optional[List[EnterpriseAgentUnitsByTestOwnerAccountGroupBreakdownsInner]] = None
    links: Optional[PaginationLinksLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["breakdowns", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "breakdowns": [EnterpriseAgentUnitsByTestOwnerAccountGroupBreakdownsInner.from_dict(_item) for _item in obj["breakdowns"]] if obj.get("breakdowns") is not None else None,
