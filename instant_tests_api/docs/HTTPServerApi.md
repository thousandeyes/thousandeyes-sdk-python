# instant_tests_api.HTTPServerApi
...
with instant_tests_api.ApiClient(configuration) as api_client:
    ...
    api_instance = instant_tests_api.HTTPServerApi(api_client)
    http_server_instant_test_request = instant_tests_api.HttpServerInstantTestRequest() # HttpServerInstantTestRequest | 
