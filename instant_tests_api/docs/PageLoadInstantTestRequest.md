...
page_load_instant_test_request_instance = PageLoadInstantTestRequest.from_json(json)
# print the JSON string representation of the object
print PageLoadInstantTestRequest.to_json()

# convert the object into a dict
page_load_instant_test_request_dict = page_load_instant_test_request_instance.to_dict()
# create an instance of PageLoadInstantTestRequest from a dict
page_load_instant_test_request_form_dict = page_load_instant_test_request.from_dict(page_load_instant_test_request_dict)
```
