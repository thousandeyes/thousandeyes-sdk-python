# instant_tests_api.HTTPPageLoadApi
...
with instant_tests_api.ApiClient(configuration) as api_client:
    ...
    api_instance = instant_tests_api.HTTPPageLoadApi(api_client)
    page_load_instant_test_request = instant_tests_api.PageLoadInstantTestRequest() # PageLoadInstantTestRequest | 
