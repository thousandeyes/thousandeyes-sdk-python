...
agent_to_server_instant_test_request_instance = AgentToServerInstantTestRequest.from_json(json)
# print the JSON string representation of the object
print AgentToServerInstantTestRequest.to_json()

# convert the object into a dict
agent_to_server_instant_test_request_dict = agent_to_server_instant_test_request_instance.to_dict()
# create an instance of AgentToServerInstantTestRequest from a dict
agent_to_server_instant_test_request_form_dict = agent_to_server_instant_test_request.from_dict(agent_to_server_instant_test_request_dict)
```
