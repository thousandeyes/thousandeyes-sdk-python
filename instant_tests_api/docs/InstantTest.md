...
instant_test_instance = InstantTest.from_json(json)
# print the JSON string representation of the object
print InstantTest.to_json()

# convert the object into a dict
instant_test_dict = instant_test_instance.to_dict()
# create an instance of InstantTest from a dict
instant_test_form_dict = instant_test.from_dict(instant_test_dict)
```
