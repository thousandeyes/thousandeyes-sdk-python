...
class TestSipCredentials(BaseModel):
    ...
    password: Optional[StrictStr] = Field(default=None, description="Password for authentication with SIP server.")
    port: Annotated[int, Field(le=65535, strict=True, ge=1024)] = Field(description="Port number for the chosen protocol.")
