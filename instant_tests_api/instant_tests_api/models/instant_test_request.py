...
class InstantTestRequest(BaseModel):
    ...
    agents: Optional[List[InstantTestRequestAgentsInner]] = Field(default=None, description="A list of objects with `agentId` (required) and `sourceIpAddress` (optional).")
