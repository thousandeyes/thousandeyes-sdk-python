...
class SipServerInstantTest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["createdBy", "createdDate", "description", "liveShare", "modifiedBy", "modifiedDate", "savedEvent", "testId", "testName", "type", "_links", "labels", "sharedWithAccounts", "agents", "authUser", "mtuMeasurements", "networkMeasurements", "optionsRegex", "password", "pathTraceMode", "port", "protocol", "registerEnabled", "sipRegistrar", "sipTargetTime", "sipTimeLimit", "targetSipCredentials", "user", "fixedPacketRate", "ipv6Policy"]
