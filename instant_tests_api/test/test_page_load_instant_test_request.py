...
class TestPageLoadInstantTestRequest(unittest.TestCase):
    """PageLoadInstantTestRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageLoadInstantTestRequest:
        """Test PageLoadInstantTestRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageLoadInstantTestRequest`
        """
        model = PageLoadInstantTestRequest()
        if include_optional:
...
',
    ...
    def testPageLoadInstantTestRequest(self):
        """Test PageLoadInstantTestRequest"""
