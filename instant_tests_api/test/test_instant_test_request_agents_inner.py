...
class TestInstantTestRequestAgentsInner(unittest.TestCase):
    """InstantTestRequestAgentsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstantTestRequestAgentsInner:
        ...
        # uncomment below to create an instance of `InstantTestRequestAgentsInner`
        """
        model = InstantTestRequestAgentsInner()
        if include_optional:
            return InstantTestRequestAgentsInner(
                agent_id = '',
                source_ip_address = ''
            )
        else:
    ...
    def testInstantTestRequestAgentsInner(self):
        """Test InstantTestRequestAgentsInner"""
