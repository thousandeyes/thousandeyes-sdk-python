...
class TestServerInstantTestRequest(unittest.TestCase):
    """ServerInstantTestRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServerInstantTestRequest:
        """Test ServerInstantTestRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServerInstantTestRequest`
        """
        model = ServerInstantTestRequest()
        if include_optional:
            return ServerInstantTestRequest(
    ...
    def testServerInstantTestRequest(self):
        """Test ServerInstantTestRequest"""
