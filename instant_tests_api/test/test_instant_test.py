...
class TestInstantTest(unittest.TestCase):
    """InstantTest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstantTest:
        """Test InstantTest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstantTest`
        """
        model = InstantTest()
        if include_optional:
            return InstantTest(
