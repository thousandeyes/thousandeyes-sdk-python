...
class EmulatedDeviceResponses(BaseModel):
    """
    EmulatedDeviceResponses
    """ # noqa: E501
    emulated_devices: Optional[List[EmulatedDeviceResponse]] = Field(default=None, alias="emulatedDevices")
    links: Optional[SelfLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["emulatedDevices", "_links"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in emulated_devices (list)
        _items = []
        if self.emulated_devices:
            for _item in self.emulated_devices:
                if _item:
                    _items.append(_item.to_dict())
            _dict['emulatedDevices'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "emulatedDevices": [EmulatedDeviceResponse.from_dict(_item) for _item in obj["emulatedDevices"]] if obj.get("emulatedDevices") is not None else None,
