...
class UserAgent(BaseModel):
    ...
    UserAgent
    """ # noqa: E501
    browser: Optional[StrictStr] = Field(default=None, description="The name of the web browser.")
    os: Optional[StrictStr] = Field(default=None, description="The operating system for the user-agent HTTP header.")
    value: Optional[StrictStr] = Field(default=None, description="The text of the user-agent header.")
    __properties: ClassVar[List[str]] = ["browser", "os", "value"]
