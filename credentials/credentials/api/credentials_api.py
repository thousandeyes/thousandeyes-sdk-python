...
from credentials.api_client import ApiClient, RequestSerialized
from credentials.api_response import ApiResponse
from credentials.rest import RESTResponseType
...
class CredentialsApi:
    ...
    @validate_call
    def create_transaction_tests_credential(
        self,
        ...
        _param = self._create_transaction_tests_credential_serialize(
    ...
    def _create_transaction_tests_credential_serialize(
        self,
        credential_request,
        aid,
        _request_auth,
    ...
    @validate_call
    def delete_transaction_tests_credential(
        self,
        ...
        _param = self._delete_transaction_tests_credential_serialize(
            id=id,
            aid=aid,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def delete_transaction_tests_credential_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the desired credential.")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    def _delete_transaction_tests_credential_serialize(
        self,
        id,
        aid,
        _request_auth,
    ...
    def get_transaction_tests_credential_details(
        ...
        _param = self._get_transaction_tests_credential_details_serialize(
            id=id,
            aid=aid,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_transaction_tests_credential_details_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the desired credential.")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_transaction_tests_credential_details_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the desired credential.")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    def _get_transaction_tests_credential_details_serialize(
        self,
        id,
        aid,
        _request_auth,
    ...
    @validate_call
    def get_transaction_tests_credentials_list(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_transaction_tests_credentials_list_serialize(
            aid=aid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetTransactionTestsCredentialsList200Response",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
            '429': "Error",
    ...
    @validate_call
    def get_transaction_tests_credentials_list_with_http_info(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetTransactionTestsCredentialsList200Response]:
        """List credentials
    ...
    @validate_call
    def get_transaction_tests_credentials_list_without_preload_content(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_transaction_tests_credentials_list_serialize(
        self,
        aid,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def update_transaction_tests_credential(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the desired credential.")],
        credential_request: CredentialRequest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        ...
        _param = self._update_transaction_tests_credential_serialize(
            id=id,
            credential_request=credential_request,
            aid=aid,
            _request_auth=_request_auth,
    ...
    @validate_call
    def update_transaction_tests_credential_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the desired credential.")],
        credential_request: CredentialRequest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
    ...
    @validate_call
    def update_transaction_tests_credential_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the desired credential.")],
        credential_request: CredentialRequest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
    ...
    def _update_transaction_tests_credential_serialize(
        self,
        id,
        credential_request,
        aid,
