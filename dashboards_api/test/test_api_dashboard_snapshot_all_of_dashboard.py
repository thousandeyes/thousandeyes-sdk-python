...
class TestApiDashboardSnapshotAllOfDashboard(unittest.TestCase):
    """ApiDashboardSnapshotAllOfDashboard unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiDashboardSnapshotAllOfDashboard:
        """Test ApiDashboardSnapshotAllOfDashboard
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiDashboardSnapshotAllOfDashboard`
        """
        model = ApiDashboardSnapshotAllOfDashboard()
        if include_optional:
            return ApiDashboardSnapshotAllOfDashboard(
    ...
    def testApiDashboardSnapshotAllOfDashboard(self):
        """Test ApiDashboardSnapshotAllOfDashboard"""
