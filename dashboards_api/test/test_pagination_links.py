    ...
    def make_instance(self, include_optional) -> PaginationLinks:
        ...
        if include_optional:
            return PaginationLinks(
                links = dashboards_api.models.pagination_links__links.PaginationLinks__links(
                    previous = dashboards_api.models.link.Link(
                        ...
                        title = '', 
                        hreflang = '', ), 
                    next = dashboards_api.models.link.Link(
                        href = 'https://api.thousandeyes.com/v7/link/to/resource/id', 
                        templated = True, 
                        type = '', 
                        deprecation = '', 
