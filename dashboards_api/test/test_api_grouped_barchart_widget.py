...
class TestApiGroupedBarchartWidget(unittest.TestCase):
    """ApiGroupedBarchartWidget unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiGroupedBarchartWidget:
        """Test ApiGroupedBarchartWidget
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiGroupedBarchartWidget`
        """
        model = ApiGroupedBarchartWidget()
        if include_optional:
            return ApiGroupedBarchartWidget(
                id = '1234',
                type = 'Pie Chart',
                title = 'Widget Title',
                visual_mode = 'Full',
    ...
    def testApiGroupedBarchartWidget(self):
        """Test ApiGroupedBarchartWidget"""
