...
class TestApiBoxAndWhiskersWidget(unittest.TestCase):
    """ApiBoxAndWhiskersWidget unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiBoxAndWhiskersWidget:
        """Test ApiBoxAndWhiskersWidget
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiBoxAndWhiskersWidget`
        """
        model = ApiBoxAndWhiskersWidget()
        if include_optional:
            return ApiBoxAndWhiskersWidget(
                id = '1234',
                type = 'Pie Chart',
                title = 'Widget Title',
                visual_mode = 'Full',
    ...
    def testApiBoxAndWhiskersWidget(self):
        """Test ApiBoxAndWhiskersWidget"""
