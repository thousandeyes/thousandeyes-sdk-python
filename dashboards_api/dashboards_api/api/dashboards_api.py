...
from dashboards_api.api_client import ApiClient
from dashboards_api.api_response import ApiResponse
from dashboards_api.rest import RESTResponseType
...
class DashboardsApi:
    ...
    def create_dashboard(
        self,
        api_dashboard: Annotated[ApiDashboard, Field(description="Request body schema to create a dashboard.")],
        ...
        :param api_dashboard: Request body schema to create a dashboard. (required)
        :type api_dashboard: ApiDashboard
    ...
    def _create_dashboard_serialize(
        ...
        if api_dashboard is not None:
            _body_params = api_dashboard
    ...
    def get_dashboard_data(
        ...
        _param = self._get_dashboard_data_serialize(
            dashboard_id=dashboard_id,
            widget_id=widget_id,
            aid=aid,
            window=window,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetDashboardData200Response",
            '400': "Error",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
    ...
    @validate_call
    def get_dashboard_data_with_http_info(
        self,
        dashboard_id: Annotated[StrictStr, Field(description="A Identifier for a dashboard which can be obtained from the `/dashboards` endpoint.")],
        widget_id: Annotated[StrictStr, Field(description="A Identifier for a widget.")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetDashboardData200Response]:
        """Retrieve dashboard widget data
    ...
    @validate_call
    def get_dashboard_data_without_preload_content(
        self,
        dashboard_id: Annotated[StrictStr, Field(description="A Identifier for a dashboard which can be obtained from the `/dashboards` endpoint.")],
        widget_id: Annotated[StrictStr, Field(description="A Identifier for a widget.")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
    ...
    def _get_dashboard_data_serialize(
        self,
        dashboard_id,
        widget_id,
        aid,
    ...
    def get_dashboards_for_user(
        ...
        _param = self._get_dashboards_for_user_serialize(
            aid=aid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_dashboards_for_user_with_http_info(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_dashboards_for_user_without_preload_content(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_dashboards_for_user_serialize(
        self,
        aid,
        _request_auth,
        _content_type,
    ...
    def update_dashboard(
        self,
        dashboard_id: Annotated[StrictStr, Field(description="A Identifier for a dashboard which can be obtained from the `/dashboards` endpoint.")],
        api_dashboard: Annotated[ApiDashboard, Field(description="Request body schema to update a dashboard.")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param dashboard_id: A Identifier for a dashboard which can be obtained from the `/dashboards` endpoint. (required)
        :type dashboard_id: str
        :param api_dashboard: Request body schema to update a dashboard. (required)
        :type api_dashboard: ApiDashboard
        :param aid: A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.
        :type aid: str
        :param _request_timeout: timeout setting for this request. If one
