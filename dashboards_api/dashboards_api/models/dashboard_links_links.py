...
class DashboardLinksLinks(BaseModel):
    """
    DashboardLinksLinks
    """ # noqa: E501
    var_self: Optional[Link] = Field(default=None, alias="self")
    snapshots: Optional[Link] = None
    __properties: ClassVar[List[str]] = ["self", "snapshots"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "snapshots": Link.from_dict(obj.get("snapshots")) if obj.get("snapshots") is not None else None
        })
        return _obj
