...
class ApiWidgetsDataV2(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "cards": [ApiNumbersCardData.from_dict(_item) for _item in obj.get("cards")] if obj.get("cards") is not None else None,
            "columns": [ApiMultiMetricColumnData.from_dict(_item) for _item in obj.get("columns")] if obj.get("columns") is not None else None,
            "points": [ApiWidgetDataPoint.from_dict(_item) for _item in obj.get("points")] if obj.get("points") is not None else None,
            "tests": [ApiTestTableData.from_dict(_item) for _item in obj.get("tests")] if obj.get("tests") is not None else None,
            "startRound": obj.get("startRound"),
            "alertSuppressionWindows": [ApiDashboardAsw.from_dict(_item) for _item in obj.get("alertSuppressionWindows")] if obj.get("alertSuppressionWindows") is not None else None,
            "totalAlerts": obj.get("totalAlerts"),
            "activeAlerts": obj.get("activeAlerts"),
            "alerts": [ApiAlertListAlert.from_dict(_item) for _item in obj.get("alerts")] if obj.get("alerts") is not None else None,
            "summary": ApiAgentStatusSummary.from_dict(obj.get("summary")) if obj.get("summary") is not None else None,
            "agents": [ApiAgentStatusAgent.from_dict(_item) for _item in obj.get("agents")] if obj.get("agents") is not None else None,
