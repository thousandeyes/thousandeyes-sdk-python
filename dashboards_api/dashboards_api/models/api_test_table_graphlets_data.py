...
class ApiTestTableGraphletsData(BaseModel):
    """
    ...
    points: Optional[List[ApiGraphletPoint]] = None
    __properties: ClassVar[List[str]] = ["metric", "testId", "points"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "points": [ApiGraphletPoint.from_dict(_item) for _item in obj.get("points")] if obj.get("points") is not None else None
        })
        return _obj
