...
class ApiAgentStatusAgent(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "ipInfo": ApiAgentStatusIpInfo.from_dict(obj.get("ipInfo")) if obj.get("ipInfo") is not None else None,
            "agentName": obj.get("agentName"),
            "location": ApiAgentLocation.from_dict(obj.get("location")) if obj.get("location") is not None else None
        })
        return _obj
