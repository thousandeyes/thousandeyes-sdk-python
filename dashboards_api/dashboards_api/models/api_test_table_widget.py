...
class ApiTestTableWidget(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "title", "visualMode", "embedUrl", "isEmbedded", "metricGroup", "direction", "metric", "filters", "measure", "fixedTimespan", "apiLink", "shouldExcludeAlertSuppressionWindows", "_links", "filter", "exclude", "dataSource"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "filter": ApiWidgetFilterApiTestTableFilterKey.from_dict(obj.get("filter")) if obj.get("filter") is not None else None,
            "exclude": ApiWidgetFilterApiTestTableFilterKey.from_dict(obj.get("exclude")) if obj.get("exclude") is not None else None,
