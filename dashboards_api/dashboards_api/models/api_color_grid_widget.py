...
class ApiColorGridWidget(BaseModel):
    """
    ...
    cards: Optional[ApiAggregateProperty] = None
    group_cards_by: Optional[ApiAggregateProperty] = Field(default=None, alias="groupCardsBy")
    columns: Optional[StrictInt] = Field(default=None, description="Number of columns: 1 or 2.")
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "title", "visualMode", "embedUrl", "isEmbedded", "metricGroup", "direction", "metric", "filters", "measure", "fixedTimespan", "apiLink", "shouldExcludeAlertSuppressionWindows", "_links", "minScale", "maxScale", "unit", "cards", "groupCardsBy", "columns", "limit", "sortBy", "sortDirection", "dataSource"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "unit": obj.get("unit"),
            "cards": obj.get("cards"),
            "groupCardsBy": obj.get("groupCardsBy"),
