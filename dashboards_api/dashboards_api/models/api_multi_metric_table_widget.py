...
class ApiMultiMetricTableWidget(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "title", "visualMode", "embedUrl", "isEmbedded", "metricGroup", "direction", "metric", "filters", "measure", "fixedTimespan", "apiLink", "shouldExcludeAlertSuppressionWindows", "_links", "compareToPreviousValue", "rowGroupBy", "sortBy", "sortDirection", "limit", "multiMetricColumns", "dataSource"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "limit": obj.get("limit"),
            "multiMetricColumns": [ApiMultiMetricColumn.from_dict(_item) for _item in obj.get("multiMetricColumns")] if obj.get("multiMetricColumns") is not None else None,
