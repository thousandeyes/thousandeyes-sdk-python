...
class DashboardSnapshotLinksLinks(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["self", "appLink"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "appLink": Link.from_dict(obj.get("appLink")) if obj.get("appLink") is not None else None
        })
        return _obj
