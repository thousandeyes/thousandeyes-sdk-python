...
class ApiAlertListWidget(BaseModel):
    ...
    alert_types: Optional[List[ApiAlertListAlertType]] = Field(default=None, description="List of alert types configured in the widget, an empty list means all alert types.", alias="alertTypes")
    ...
    active_within: Optional[ApiAlertListWidgetAllOfActiveWithin] = Field(default=None, alias="activeWithin")
    data_source: Optional[AlertListDatasource] = Field(default=None, alias="dataSource")
    __properties: ClassVar[List[str]] = ["id", "type", "title", "visualMode", "embedUrl", "isEmbedded", "metricGroup", "direction", "metric", "filters", "measure", "fixedTimespan", "apiLink", "shouldExcludeAlertSuppressionWindows", "_links", "alertTypes", "limitTo", "activeWithin", "dataSource"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "activeWithin": ApiAlertListWidgetAllOfActiveWithin.from_dict(obj.get("activeWithin")) if obj.get("activeWithin") is not None else None,
