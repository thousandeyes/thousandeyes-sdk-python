...
class DashboardSnapshots200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["dashboardSnapshots", "_links"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "dashboardSnapshots": [ApiDashboardSnapshot.from_dict(_item) for _item in obj.get("dashboardSnapshots")] if obj.get("dashboardSnapshots") is not None else None,
