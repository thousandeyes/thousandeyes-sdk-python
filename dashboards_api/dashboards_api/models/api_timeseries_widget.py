...
class ApiTimeseriesWidget(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "title", "visualMode", "embedUrl", "isEmbedded", "metricGroup", "direction", "metric", "filters", "measure", "fixedTimespan", "apiLink", "shouldExcludeAlertSuppressionWindows", "_links", "minScale", "maxScale", "unit", "showTimeseriesOverallBaseline", "groupBy", "isTimeseriesOneChartPerLine", "dataSource"]
