...
class ApiAgentStatusWidget(BaseModel):
    ...
    agents: Optional[AgentWidgetType] = None
    show: Optional[AgentWidgetShow] = None
    data_source: Optional[AgentStatusDatasource] = Field(default=None, alias="dataSource")
    __properties: ClassVar[List[str]] = ["id", "type", "title", "visualMode", "embedUrl", "isEmbedded", "metricGroup", "direction", "metric", "filters", "measure", "fixedTimespan", "apiLink", "shouldExcludeAlertSuppressionWindows", "_links", "agents", "show", "dataSource"]
