...
class GetDashboardData200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["startDate", "endDate", "groupLabels", "binSize", "data", "_links"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "groupLabels": [ApiReportDataComponentLabelMap.from_dict(_item) for _item in obj.get("groupLabels")] if obj.get("groupLabels") is not None else None,
            "binSize": obj.get("binSize"),
            "data": ApiWidgetsDataV2.from_dict(obj.get("data")) if obj.get("data") is not None else None,
