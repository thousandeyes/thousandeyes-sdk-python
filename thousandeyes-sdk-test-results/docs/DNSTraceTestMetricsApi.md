# thousandeyes_sdk.test_results.DNSTraceTestMetricsApi

All URIs are relative to *https://api.thousandeyes.com/v7*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_test_dns_trace_results**](DNSTraceTestMetricsApi.md#get_test_dns_trace_results) | **GET** /test-results/{testId}/dns-trace | Get DNS trace test results
...
with thousandeyes_sdk.test_results.ApiClient(configuration) as api_client:
    ...
    api_instance = thousandeyes_sdk.test_results.DNSTraceTestMetricsApi(api_client)
