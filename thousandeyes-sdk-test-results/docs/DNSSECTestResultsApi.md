# thousandeyes_sdk.test_results.DNSSECTestResultsApi

All URIs are relative to *https://api.thousandeyes.com/v7*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_test_dns_sec_results**](DNSSECTestResultsApi.md#get_test_dns_sec_results) | **GET** /test-results/{testId}/dnssec | Get DNSSEC test results
...
with thousandeyes_sdk.core.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DNSSECTestResultsApi->get_test_dns_sec_results: %s\n" % e)
```
