# thousandeyes_sdk.test_results.WebFTPServerTestResultsApi

All URIs are relative to *https://api.thousandeyes.com/v7*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_test_ftp_server_results**](WebFTPServerTestResultsApi.md#get_test_ftp_server_results) | **GET** /test-results/{testId}/ftp-server | Get FTP server test results
...
with thousandeyes_sdk.core.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling WebFTPServerTestResultsApi->get_test_ftp_server_results: %s\n" % e)
```
