...
> PathVisDetailTestResults get_test_pathvis_agent_round(test_id, agent_id, round_id, aid=aid, direction=direction)
...
> NetworkTestResults get_test_result_metrics(test_id, aid=aid, window=window, start_date=start_date, end_date=end_date, cursor=cursor, direction=direction)
...
> PathVisTestResults get_test_result_network_path_vis(test_id, aid=aid, window=window, start_date=start_date, end_date=end_date, cursor=cursor, direction=direction)
