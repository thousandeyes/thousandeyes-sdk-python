# thousandeyes_sdk.test_results.DNSTraceTestResultsApi

All URIs are relative to *https://api.thousandeyes.com/v7*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_test_dns_trace_results**](DNSTraceTestResultsApi.md#get_test_dns_trace_results) | **GET** /test-results/{testId}/dns-trace | Get DNS trace test results
...
with thousandeyes_sdk.core.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DNSTraceTestResultsApi->get_test_dns_trace_results: %s\n" % e)
```
