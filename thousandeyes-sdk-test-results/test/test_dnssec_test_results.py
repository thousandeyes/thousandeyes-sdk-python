...
class TestDnssecTestResults(unittest.TestCase):
    """DnssecTestResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DnssecTestResults:
        """Test DnssecTestResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DnssecTestResults`
        """
        model = DnssecTestResults()
        if include_optional:
    ...
    def testDnssecTestResults(self):
        """Test DnssecTestResults"""
