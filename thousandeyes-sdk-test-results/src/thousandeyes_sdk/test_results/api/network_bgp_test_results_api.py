...
class NetworkBGPTestResultsApi:
    ...
    def get_test_bgp_results(
        ...
        _param = self._get_test_bgp_results_serialize(
            test_id=test_id,
            aid=aid,
            window=window,
    ...
    @validate_call
    def get_test_bgp_results_with_http_info(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        window: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="A dynamic time interval up to the current time of the request. Specify the interval as a number followed by an optional type: `s` for seconds (default if no type is specified), `m` for minutes, `h` for hours, `d` for days, and `w` for weeks. For a precise date range, use `startDate` and `endDate`.")] = None,
    ...
    @validate_call
    def get_test_bgp_results_without_preload_content(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        window: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="A dynamic time interval up to the current time of the request. Specify the interval as a number followed by an optional type: `s` for seconds (default if no type is specified), `m` for minutes, `h` for hours, `d` for days, and `w` for weeks. For a precise date range, use `startDate` and `endDate`.")] = None,
    ...
    def _get_test_bgp_results_serialize(
        self,
        test_id,
        aid,
        window,
    ...
    @validate_call
    def get_test_bgp_routes_prefix_round_results(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        ...
        _param = self._get_test_bgp_routes_prefix_round_results_serialize(
            test_id=test_id,
            prefix_id=prefix_id,
            round_id=round_id,
            aid=aid,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BgpTestRouteInformationResults",
            '400': "ValidationError",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
    ...
    @validate_call
    def get_test_bgp_routes_prefix_round_results_with_http_info(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        prefix_id: Annotated[StrictStr, Field(description="The ID of the prefix. You can get `prefixId` from the `/test-results/{testId}/bgp` endpoint.")],
        round_id: Annotated[StrictStr, Field(description="Round ID")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BgpTestRouteInformationResults]:
        """Get BGP route test results by prefix
    ...
    def _get_test_bgp_routes_prefix_round_results_serialize(
        self,
        test_id,
        prefix_id,
        round_id,
