...
class WebTransactionsTestResultsApi:
    ...
    @validate_call
    def get_test_console_logs_agent_round_results(
        self,
        ...
        _param = self._get_test_console_logs_agent_round_results_serialize(
            test_id=test_id,
            agent_id=agent_id,
            round_id=round_id,
            aid=aid,
    ...
    @validate_call
    def get_test_console_logs_agent_round_results_with_http_info(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        agent_id: Annotated[StrictStr, Field(description="Agent ID")],
        round_id: Annotated[StrictStr, Field(description="Round ID")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ConsoleLogsTestResults]:
        """Get console logs test results by agent and round
    ...
    @validate_call
    def get_test_console_logs_agent_round_results_without_preload_content(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        agent_id: Annotated[StrictStr, Field(description="Agent ID")],
        round_id: Annotated[StrictStr, Field(description="Round ID")],
    ...
    def _get_test_console_logs_agent_round_results_serialize(
        self,
        test_id,
        agent_id,
        round_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/test-results/{testId}/web-transactions/agent/{agentId}/round/{roundId}/console-logs',
    ...
    @validate_call
    def get_test_web_transaction_agent_round_page_results(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        agent_id: Annotated[StrictStr, Field(description="Agent ID")],
        round_id: Annotated[StrictStr, Field(description="Round ID")],
        ...
        _param = self._get_test_web_transaction_agent_round_page_results_serialize(
            test_id=test_id,
            agent_id=agent_id,
            round_id=round_id,
            page_id=page_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "WebTransactionPageDetailTestResults",
            '400': "ValidationError",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
    ...
    @validate_call
    def get_test_web_transaction_agent_round_page_results_with_http_info(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        agent_id: Annotated[StrictStr, Field(description="Agent ID")],
        round_id: Annotated[StrictStr, Field(description="Round ID")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WebTransactionPageDetailTestResults]:
        """Get detailed web transactions test result by agent, round, and page
    ...
    @validate_call
    def get_test_web_transaction_agent_round_page_results_without_preload_content(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        agent_id: Annotated[StrictStr, Field(description="Agent ID")],
        round_id: Annotated[StrictStr, Field(description="Round ID")],
    ...
    def _get_test_web_transaction_agent_round_page_results_serialize(
        self,
        test_id,
        agent_id,
        round_id,
    ...
    @validate_call
    def get_test_web_transaction_agent_round_results(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        agent_id: Annotated[StrictStr, Field(description="Agent ID")],
        round_id: Annotated[StrictStr, Field(description="Round ID")],
        ...
        _param = self._get_test_web_transaction_agent_round_results_serialize(
            test_id=test_id,
            agent_id=agent_id,
            round_id=round_id,
            aid=aid,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "WebTransactionDetailTestResults",
            '400': "ValidationError",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
    ...
    @validate_call
    def get_test_web_transaction_agent_round_results_with_http_info(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        agent_id: Annotated[StrictStr, Field(description="Agent ID")],
        round_id: Annotated[StrictStr, Field(description="Round ID")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WebTransactionDetailTestResults]:
        """Get web transactions test results by agent and round
    ...
    @validate_call
    def get_test_web_transaction_agent_round_results_without_preload_content(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        agent_id: Annotated[StrictStr, Field(description="Agent ID")],
        round_id: Annotated[StrictStr, Field(description="Round ID")],
    ...
    def _get_test_web_transaction_agent_round_results_serialize(
        self,
        test_id,
        agent_id,
        round_id,
    ...
    @validate_call
    def get_test_web_transaction_results(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        window: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="A dynamic time interval up to the current time of the request. Specify the interval as a number followed by an optional type: `s` for seconds (default if no type is specified), `m` for minutes, `h` for hours, `d` for days, and `w` for weeks. For a precise date range, use `startDate` and `endDate`.")] = None,
    ...
    @validate_call
    def get_test_web_transaction_results_without_preload_content(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        window: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="A dynamic time interval up to the current time of the request. Specify the interval as a number followed by an optional type: `s` for seconds (default if no type is specified), `m` for minutes, `h` for hours, `d` for days, and `w` for weeks. For a precise date range, use `startDate` and `endDate`.")] = None,
