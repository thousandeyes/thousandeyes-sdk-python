...
class TestResultMonitor(BaseModel):
    """
    TestResultMonitor
    """ # noqa: E501
    monitor_id: Optional[StrictStr] = Field(default=None, description="Unique monitor ID.", alias="monitorId")
    ...
    __properties: ClassVar[List[str]] = ["monitorId", "monitorName", "countryId"]
