...
class ConsoleLogsResult(BaseModel):
    ...
    console_logs: Optional[List[ConsoleLogs]] = Field(default=None, alias="consoleLogs")
    __properties: ClassVar[List[str]] = ["date", "roundId", "_links", "agent", "consoleLogs"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in console_logs (list)
        _items = []
        if self.console_logs:
            for _item in self.console_logs:
                if _item:
                    _items.append(_item.to_dict())
            _dict['consoleLogs'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "consoleLogs": [ConsoleLogs.from_dict(_item) for _item in obj["consoleLogs"]] if obj.get("consoleLogs") is not None else None
        })
        return _obj
