...
class ApiTestResults(BaseModel):
    """
    ApiTestResults
    """ # noqa: E501
    results: Optional[List[ApiTestResult]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [ApiTestResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
