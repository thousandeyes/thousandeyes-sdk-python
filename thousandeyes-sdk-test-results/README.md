...
------------ | ------------- | ------------- | -------------
*APITestMetricsApi* | [**get_test_result_api**](docs/APITestMetricsApi.md#get_test_result_api) | **GET** /v7/test-results/{testId}/api | Get API test results
*APITestMetricsApi* | [**get_test_result_api_component_detail**](docs/APITestMetricsApi.md#get_test_result_api_component_detail) | **GET** /v7/test-results/{testId}/api/agent/{agentId}/round/{roundId} | Get API test results by agent and round
