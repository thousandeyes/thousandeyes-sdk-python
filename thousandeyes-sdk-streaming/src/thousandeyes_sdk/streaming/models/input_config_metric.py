...
class InputConfigMetric(BaseModel):
    """
    Configuration for metric input data in the stream integration.
    """ # noqa: E501
    connected_devices: Optional[ConnectedDevices] = Field(default=None, alias="connectedDevices")
    __properties: ClassVar[List[str]] = ["connectedDevices"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "connectedDevices": ConnectedDevices.from_dict(obj["connectedDevices"]) if obj.get("connectedDevices") is not None else None
        })
        return _obj
