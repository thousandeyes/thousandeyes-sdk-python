...
class ExporterConfigAuthorization(BaseModel):
    """
    Authentication configuration type.
    """ # noqa: E501
    o_auth2: Optional[ExporterConfigOAuth2] = Field(default=None, alias="oAuth2")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "oAuth2": ExporterConfigOAuth2.from_dict(obj["oAuth2"]) if obj.get("oAuth2") is not None else None
        })
        return _obj
