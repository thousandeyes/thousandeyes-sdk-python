...
class TestOrganizationQuota(unittest.TestCase):
    """OrganizationQuota unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrganizationQuota:
        """Test OrganizationQuota
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganizationQuota`
        """
    ...
    def testOrganizationQuota(self):
        """Test OrganizationQuota"""
