...
class GetUsage200Response(BaseModel):
    ...
    GetUsage200Response
    """ # noqa: E501
    usage: Optional[UsageUsage] = None
    links: Optional[SelfLinksLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["usage", "_links"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "usage": UsageUsage.from_dict(obj.get("usage")) if obj.get("usage") is not None else None,
