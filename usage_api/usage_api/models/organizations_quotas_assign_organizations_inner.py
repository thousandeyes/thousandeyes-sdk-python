...
class OrganizationsQuotasAssignOrganizationsInner(BaseModel):
    """
    OrganizationsQuotasAssignOrganizationsInner
    """ # noqa: E501
    org_id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the organization.", alias="orgId")
    account_groups: Optional[List[AccountGroupQuota]] = Field(default=None, description="List of account groups quotas.", alias="accountGroups")
    __properties: ClassVar[List[str]] = ["orgId", "accountGroups"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "orgId": obj.get("orgId"),
            "accountGroups": [AccountGroupQuota.from_dict(_item) for _item in obj.get("accountGroups")] if obj.get("accountGroups") is not None else None
        })
        return _obj
