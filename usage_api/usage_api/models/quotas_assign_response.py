...
class QuotasAssignResponse(BaseModel):
    """
    QuotasAssignResponse
    """ # noqa: E501
    organizations: Optional[List[OrganizationQuota]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "organizations": [OrganizationQuota.from_dict(_item) for _item in obj.get("organizations")] if obj.get("organizations") is not None else None
        })
        return _obj
