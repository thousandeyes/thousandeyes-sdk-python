...
class GetQuotas200Response(BaseModel):
    """
    GetQuotas200Response
    """ # noqa: E501
    quotas: Optional[List[QuotasQuotasInner]] = None
    links: Optional[SelfLinksLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["quotas", "_links"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "quotas": [QuotasQuotasInner.from_dict(_item) for _item in obj.get("quotas")] if obj.get("quotas") is not None else None,
