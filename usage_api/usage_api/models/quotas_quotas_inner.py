...
class QuotasQuotasInner(BaseModel):
    """
    QuotasQuotasInner
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "organizationQuota": OrganizationQuota.from_dict(obj.get("organizationQuota")) if obj.get("organizationQuota") is not None else None,
            "accountGroupQuotas": [AccountGroupQuota.from_dict(_item) for _item in obj.get("accountGroupQuotas")] if obj.get("accountGroupQuotas") is not None else None
        })
        return _obj
