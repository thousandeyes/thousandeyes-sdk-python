...
with instant_tests.ApiClient(configuration) as api_client:
    ...
    api_instance = instant_tests.FTPServerApi(api_client)
    server_instant_test_request = instant_tests.ServerInstantTestRequest() # ServerInstantTestRequest | 
