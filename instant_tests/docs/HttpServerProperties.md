...
http_server_properties_instance = HttpServerProperties.from_json(json)
# print the JSON string representation of the object
print(HttpServerProperties.to_json())

# convert the object into a dict
http_server_properties_dict = http_server_properties_instance.to_dict()
# create an instance of HttpServerProperties from a dict
http_server_properties_from_dict = HttpServerProperties.from_dict(http_server_properties_dict)
```
