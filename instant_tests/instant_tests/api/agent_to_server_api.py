...
class AgentToServerApi:
    ...
    @validate_call
    def post_instant_agent_to_server(
        self,
        ...
        :param agent_to_server_instant_test_request: (required)
        :type agent_to_server_instant_test_request: AgentToServerInstantTestRequest
        ...
        _param = self._post_instant_agent_to_server_serialize(
    ...
    @validate_call
    def post_instant_agent_to_server_with_http_info(
        self,
        agent_to_server_instant_test_request: AgentToServerInstantTestRequest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        expand: Annotated[Optional[List[Expand]], Field(description="(Optional) Indicates if the test sub-resources should be expanded. Defaults to no expansion. To expand the `agents` sub-resource, use the query `?expand=agent`.")] = None,
    ...
    @validate_call
    def post_instant_agent_to_server_without_preload_content(
        self,
        agent_to_server_instant_test_request: AgentToServerInstantTestRequest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        expand: Annotated[Optional[List[Expand]], Field(description="(Optional) Indicates if the test sub-resources should be expanded. Defaults to no expansion. To expand the `agents` sub-resource, use the query `?expand=agent`.")] = None,
    ...
    def _post_instant_agent_to_server_serialize(
        self,
        ...
        if agent_to_server_instant_test_request is not None:
            _body_params = agent_to_server_instant_test_request
