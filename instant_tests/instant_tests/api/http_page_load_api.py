...
class HTTPPageLoadApi:
    ...
    @validate_call
    def post_instant_http_page_load(
        self,
        ...
        :param page_load_instant_test_request: (required)
        :type page_load_instant_test_request: PageLoadInstantTestRequest
        ...
        _param = self._post_instant_http_page_load_serialize(
    ...
    @validate_call
    def post_instant_http_page_load_with_http_info(
        self,
        page_load_instant_test_request: PageLoadInstantTestRequest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        expand: Annotated[Optional[List[Expand]], Field(description="(Optional) Indicates if the test sub-resources should be expanded. Defaults to no expansion. To expand the `agents` sub-resource, use the query `?expand=agent`.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PageLoadInstantTest]:
        """Create HTTP page load instant test
    ...
    @validate_call
    def post_instant_http_page_load_without_preload_content(
        self,
        page_load_instant_test_request: PageLoadInstantTestRequest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        expand: Annotated[Optional[List[Expand]], Field(description="(Optional) Indicates if the test sub-resources should be expanded. Defaults to no expansion. To expand the `agents` sub-resource, use the query `?expand=agent`.")] = None,
    ...
    def _post_instant_http_page_load_serialize(
        self,
        ...
        if page_load_instant_test_request is not None:
            _body_params = page_load_instant_test_request
