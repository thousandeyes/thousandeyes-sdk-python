...
class DNSTraceApi:
    ...
    def post_instant_dns_trace(
        ...
        :param dns_trace_instant_test_request: (required)
        :type dns_trace_instant_test_request: DnsTraceInstantTestRequest
        ...
        _param = self._post_instant_dns_trace_serialize(
    ...
    @validate_call
    def post_instant_dns_trace_with_http_info(
        self,
        dns_trace_instant_test_request: DnsTraceInstantTestRequest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        expand: Annotated[Optional[List[Expand]], Field(description="(Optional) Indicates if the test sub-resources should be expanded. Defaults to no expansion. To expand the `agents` sub-resource, use the query `?expand=agent`.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DnsTraceInstantTest]:
        """Create DNS trace instant test
    ...
    @validate_call
    def post_instant_dns_trace_without_preload_content(
        self,
        dns_trace_instant_test_request: DnsTraceInstantTestRequest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        expand: Annotated[Optional[List[Expand]], Field(description="(Optional) Indicates if the test sub-resources should be expanded. Defaults to no expansion. To expand the `agents` sub-resource, use the query `?expand=agent`.")] = None,
    ...
    def _post_instant_dns_trace_serialize(
        self,
        ...
        if dns_trace_instant_test_request is not None:
            _body_params = dns_trace_instant_test_request
