...
class VoiceApi:
    ...
    def post_instant_voice(
        ...
        :param voice_instant_test_request: (required)
        :type voice_instant_test_request: VoiceInstantTestRequest
        ...
        _param = self._post_instant_voice_serialize(
    ...
    def _post_instant_voice_serialize(
        self,
        ...
        if voice_instant_test_request is not None:
            _body_params = voice_instant_test_request
