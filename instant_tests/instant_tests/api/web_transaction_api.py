...
class WebTransactionApi:
    ...
    @validate_call
    def post_instant_web_transactions(
        self,
        ...
        :param web_transaction_instant_test_request: (required)
        :type web_transaction_instant_test_request: WebTransactionInstantTestRequest
        ...
        _param = self._post_instant_web_transactions_serialize(
    ...
    @validate_call
    def post_instant_web_transactions_with_http_info(
        self,
        web_transaction_instant_test_request: WebTransactionInstantTestRequest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        expand: Annotated[Optional[List[Expand]], Field(description="(Optional) Indicates if the test sub-resources should be expanded. Defaults to no expansion. To expand the `agents` sub-resource, use the query `?expand=agent`.")] = None,
    ...
    @validate_call
    def post_instant_web_transactions_without_preload_content(
        self,
        web_transaction_instant_test_request: WebTransactionInstantTestRequest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        expand: Annotated[Optional[List[Expand]], Field(description="(Optional) Indicates if the test sub-resources should be expanded. Defaults to no expansion. To expand the `agents` sub-resource, use the query `?expand=agent`.")] = None,
    ...
    def _post_instant_web_transactions_serialize(
        self,
        ...
        if web_transaction_instant_test_request is not None:
            _body_params = web_transaction_instant_test_request
