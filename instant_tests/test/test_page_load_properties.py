...
class TestPageLoadProperties(unittest.TestCase):
    """PageLoadProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageLoadProperties:
        """Test PageLoadProperties
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageLoadProperties`
        """
        model = PageLoadProperties()
        if include_optional:
            return PageLoadProperties(
                auth_type = 'none',
...
',
    ...
    def testPageLoadProperties(self):
        """Test PageLoadProperties"""
