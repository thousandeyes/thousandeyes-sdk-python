...
class TestsUsage(BaseModel):
    """
    TestsUsage
    """ # noqa: E501
    breakdowns: Optional[List[UnitsByTests]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "breakdowns": [UnitsByTests.from_dict(_item) for _item in obj["breakdowns"]] if obj.get("breakdowns") is not None else None,
