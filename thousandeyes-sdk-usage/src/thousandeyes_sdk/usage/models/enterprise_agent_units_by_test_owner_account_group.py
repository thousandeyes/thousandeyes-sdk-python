...
class EnterpriseAgentUnitsByTestOwnerAccountGroup(BaseModel):
    """
    EnterpriseAgentUnitsByTestOwnerAccountGroup
    """ # noqa: E501
    aid: Optional[StrictStr] = Field(default=None, description="Unique identifier of the account group where some tests are incurring the enterprise agent units.")
    account_group_name: Optional[StrictStr] = Field(default=None, description="Name of the account group which owns the tests that are incurring enterprise agent units.", alias="accountGroupName")
    agent_id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the enterprise agent generating usage. This field may be omitted when not available.", alias="agentId")
    ...
    __properties: ClassVar[List[str]] = ["aid", "accountGroupName", "agentId", "agentName", "enterpriseUnitsUsed", "enterpriseUnitsProjected"]
