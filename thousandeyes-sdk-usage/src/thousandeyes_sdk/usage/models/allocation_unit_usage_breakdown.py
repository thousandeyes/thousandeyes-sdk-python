...
class AllocationUnitUsageBreakdown(BaseModel):
    """
    AllocationUnitUsageBreakdown
    """ # noqa: E501
    product_name: Optional[StrictStr] = Field(default=None, description="The product name of the allocation.", alias="productName")
    allocated_units: Optional[StrictInt] = Field(default=None, description="The number of allocated units for the product.", alias="allocatedUnits")
    __properties: ClassVar[List[str]] = ["productName", "allocatedUnits"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "allocatedUnits": obj.get("allocatedUnits")
        })
        return _obj
