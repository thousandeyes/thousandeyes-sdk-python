...
class AccountGroupQuota(BaseModel):
    """
    AccountGroupQuota
    """ # noqa: E501
    value: Optional[StrictInt] = Field(default=None, description="Value of the quota for the given Account Group.")
    aid: Optional[StrictStr] = Field(default=None, description="Unique ID of the account group.")
    __properties: ClassVar[List[str]] = ["value", "aid"]
