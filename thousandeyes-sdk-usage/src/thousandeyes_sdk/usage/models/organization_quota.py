...
class OrganizationQuota(BaseModel):
    ...
    OrganizationQuota
    """ # noqa: E501
    value: StrictInt = Field(description="Value of the quota for the given Organization.")
    org_id: Optional[StrictStr] = Field(default=None, description="Unique ID of the organization.", alias="orgId")
    __properties: ClassVar[List[str]] = ["value", "orgId"]
