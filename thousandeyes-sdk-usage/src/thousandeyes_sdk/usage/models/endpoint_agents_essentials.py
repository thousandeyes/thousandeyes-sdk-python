...
class EndpointAgentsEssentials(BaseModel):
    """
    EndpointAgentsEssentials
    """ # noqa: E501
    aid: Optional[StrictStr] = Field(default=None, description="Unique identifier of the account group owning the endpoint agents essentials.")
    account_group_name: Optional[StrictStr] = Field(default=None, description="Name of the account group which owns the endpoint agents essentials.", alias="accountGroupName")
