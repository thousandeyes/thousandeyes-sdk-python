...
class UnitAllocationSummary(BaseModel):
    ...
    """ # noqa: E501
    used: Optional[StrictInt] = Field(default=None, description="The total number of allocation units used.")
    projected: Optional[StrictInt] = Field(default=None, description="The total number of projected allocation units.")
    allocations: Optional[List[AllocationUnitUsageBreakdown]] = None
    __properties: ClassVar[List[str]] = ["used", "projected", "allocations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "allocations": [AllocationUnitUsageBreakdown.from_dict(_item) for _item in obj["allocations"]] if obj.get("allocations") is not None else None
        })
        return _obj
