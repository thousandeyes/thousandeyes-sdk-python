...
class EndpointAgentBulkTransferRequest(BaseModel):
    """
    EndpointAgentBulkTransferRequest
    """ # noqa: E501
    transfers: Optional[List[AgentTransfer]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "transfers": [AgentTransfer.from_dict(_item) for _item in obj.get("transfers")] if obj.get("transfers") is not None else None
        })
        return _obj
