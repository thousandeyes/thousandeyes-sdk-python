...
class EndpointAgentBulkTransfer207ResponseItemsInner(BaseModel):
    """
    ...
    request: Optional[AgentTransfer] = None
    __properties: ClassVar[List[str]] = ["type", "title", "status", "detail", "instance", "request"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "request": AgentTransfer.from_dict(obj.get("request")) if obj.get("request") is not None else None
        })
        return _obj
