...
class AgentSearchRequest(BaseModel):
    ...
    """ # noqa: E501
    search_filters: Optional[AgentSearchRequestSearchFilters] = Field(default=None, alias="searchFilters")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "searchFilters": AgentSearchRequestSearchFilters.from_dict(obj.get("searchFilters")) if obj.get("searchFilters") is not None else None
        })
        return _obj
