...
class EndpointAgentBulkTransfer207Response(BaseModel):
    """
    EndpointAgentBulkTransfer207Response
    """ # noqa: E501
    items: Optional[List[EndpointAgentBulkTransfer207ResponseItemsInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "items": [EndpointAgentBulkTransfer207ResponseItemsInner.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
