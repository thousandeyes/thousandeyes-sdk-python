...
class DynamicTestRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_links", "agentSelectorConfig", "application", "createdDate", "interval", "isEnabled", "hasPathTraceInSession", "hasPing", "hasTraceroute", "modifiedDate", "networkMeasurements", "protocol", "tcpProbeMode", "testId", "aid", "testName", "agentSelectorType", "agents", "endpointAgentLabels", "maxMachines"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "_links": DynamicTestLinks.from_dict(obj.get("_links")) if obj.get("_links") is not None else None,
