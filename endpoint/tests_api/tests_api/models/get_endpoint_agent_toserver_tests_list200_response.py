...
class GetEndpointAgentToserverTestsList200Response(BaseModel):
    """
    GetEndpointAgentToserverTestsList200Response
    """ # noqa: E501
    tests: Optional[List[EndpointAgentToServerTest]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "tests": [EndpointAgentToServerTest.from_dict(_item) for _item in obj.get("tests")] if obj.get("tests") is not None else None,
