...
class EndpointSpecificAgentsSelectorConfig(BaseModel):
    """
    Specific agents selection object.
    """ # noqa: E501
    agent_selector_type: Optional[SpecificAgentsSelectorType] = Field(default=None, alias="agentSelectorType")
    max_machines: Optional[Annotated[int, Field(le=5000, strict=True, ge=1)]] = Field(default=None, description="Maximum number of agents which can execute the test.", alias="maxMachines")
    ...
    __properties: ClassVar[List[str]] = ["agentSelectorType", "maxMachines", "agents"]
