...
class NetworkProfile(BaseModel):
    ...
    subnet_mask: Optional[StrictStr] = Field(default=None, description="Network subnet mask.", alias="subnetMask")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "wirelessProfile": NetworkWirelessProfile.from_dict(obj.get("wirelessProfile")) if obj.get("wirelessProfile") is not None else None,
            "proxyProfile": NetworkProxyProfile.from_dict(obj.get("proxyProfile")) if obj.get("proxyProfile") is not None else None,
            "ethernetProfile": EthernetProfile.from_dict(obj.get("ethernetProfile")) if obj.get("ethernetProfile") is not None else None,
            "previousInterface": NetworkInterface.from_dict(obj.get("previousInterface")) if obj.get("previousInterface") is not None else None
        })
        return _obj
