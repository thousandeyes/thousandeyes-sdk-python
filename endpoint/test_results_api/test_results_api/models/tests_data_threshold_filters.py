...
class TestsDataThresholdFilters(BaseModel):
    """
    All filters are applied based on the conditional operator (and/or).
    """ # noqa: E501
    filters: Optional[List[TestsDataThresholdFilter]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "filters": [TestsDataThresholdFilter.from_dict(_item) for _item in obj.get("filters")] if obj.get("filters") is not None else None,
