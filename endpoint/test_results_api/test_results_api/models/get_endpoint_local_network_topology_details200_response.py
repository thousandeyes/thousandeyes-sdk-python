...
class GetEndpointLocalNetworkTopologyDetails200Response(BaseModel):
    """
    GetEndpointLocalNetworkTopologyDetails200Response
    """ # noqa: E501
    results: Optional[List[LocalNetworkTopologyResult]] = None
    links: Optional[SelfLinksLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["results", "_links"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "results": [LocalNetworkTopologyResult.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
