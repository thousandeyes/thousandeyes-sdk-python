...
class DynamicTestLinks(BaseModel):
    """
    A list of links that can be accessed to get more information.
    """ # noqa: E501
    var_self: Optional[DynamicTestLinksSelf] = Field(default=None, alias="self")
    test_results: Optional[DynamicTestLinksTestResults] = Field(default=None, alias="testResults")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "self": DynamicTestLinksSelf.from_dict(obj.get("self")) if obj.get("self") is not None else None,
            "testResults": DynamicTestLinksTestResults.from_dict(obj.get("testResults")) if obj.get("testResults") is not None else None
        })
        return _obj
