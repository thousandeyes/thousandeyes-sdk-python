...
class PostFetchDynamicTestResultMetrics200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "results": [NetworkDynamicTestResult.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
            "test": DynamicTest.from_dict(obj.get("test")) if obj.get("test") is not None else None,
