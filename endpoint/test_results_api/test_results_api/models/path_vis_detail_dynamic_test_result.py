...
class PathVisDetailDynamicTestResult(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["agentId", "aid", "roundId", "serverIp", "systemMetrics", "vpnProfile", "asnDetails", "server", "sourceIp", "sourcePrefix", "routes", "vpnRoutes", "application", "webex"]
