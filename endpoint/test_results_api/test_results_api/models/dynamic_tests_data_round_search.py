...
class DynamicTestsDataRoundSearch(BaseModel):
    """
    ...
    search_filters: Optional[DynamicTestsDataSearchFilter] = Field(default=None, alias="searchFilters")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "searchFilters": DynamicTestsDataSearchFilter.from_dict(obj.get("searchFilters")) if obj.get("searchFilters") is not None else None
        })
        return _obj
