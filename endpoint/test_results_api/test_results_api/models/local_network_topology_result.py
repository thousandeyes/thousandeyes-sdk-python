...
class LocalNetworkTopologyResult(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of icmp_traceroute
        if self.icmp_traceroute:
            _dict['icmpTraceroute'] = self.icmp_traceroute.to_dict()
        # override the default output from pydantic by calling `to_dict()` of each item in icmp_traceroutes (list)
        _items = []
        if self.icmp_traceroutes:
            for _item in self.icmp_traceroutes:
                if _item:
                    _items.append(_item.to_dict())
            _dict['icmpTraceroutes'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "icmpPing": NetworkPing.from_dict(obj.get("icmpPing")) if obj.get("icmpPing") is not None else None,
            "isIcmpBlocked": obj.get("isIcmpBlocked"),
            "tcpConnect": TcpConnect.from_dict(obj.get("tcpConnect")) if obj.get("tcpConnect") is not None else None,
            "systemMetrics": SystemMetrics.from_dict(obj.get("systemMetrics")) if obj.get("systemMetrics") is not None else None,
            "coordinates": RealUserTestCoordinates.from_dict(obj.get("coordinates")) if obj.get("coordinates") is not None else None,
            "networkProfile": NetworkProfile.from_dict(obj.get("networkProfile")) if obj.get("networkProfile") is not None else None,
            "icmpTraceroute": Traceroute.from_dict(obj.get("icmpTraceroute")) if obj.get("icmpTraceroute") is not None else None,
            "icmpTraceroutes": [Traceroute.from_dict(_item) for _item in obj.get("icmpTraceroutes")] if obj.get("icmpTraceroutes") is not None else None
        })
        return _obj
