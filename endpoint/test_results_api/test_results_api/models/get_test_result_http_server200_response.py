...
class GetTestResultHttpServer200Response(BaseModel):
    """
    GetTestResultHttpServer200Response
    """ # noqa: E501
    results: Optional[List[HttpTestResult]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "results": [HttpTestResult.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
            "test": EndpointHttpServerTest.from_dict(obj.get("test")) if obj.get("test") is not None else None,
