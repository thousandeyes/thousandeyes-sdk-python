...
class MultiTestIdTestsDataRoundsSearch(BaseModel):
    """
    ...
    search_filters: Optional[MultiTestIdTestsDataSearchFilter] = Field(default=None, alias="searchFilters")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "searchSort": [TestsDataSearchSort.from_dict(_item) for _item in obj.get("searchSort")] if obj.get("searchSort") is not None else None,
            "thresholdFilter": TestsDataThresholdFilters.from_dict(obj.get("thresholdFilter")) if obj.get("thresholdFilter") is not None else None,
            "searchFilters": MultiTestIdTestsDataSearchFilter.from_dict(obj.get("searchFilters")) if obj.get("searchFilters") is not None else None
        })
        return _obj
