...
class RealUserTestNetworkResult(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "destination": NetworkMetrics.from_dict(obj.get("destination")) if obj.get("destination") is not None else None,
            "vpn": NetworkMetrics.from_dict(obj.get("vpn")) if obj.get("vpn") is not None else None,
            "proxy": NetworkMetrics.from_dict(obj.get("proxy")) if obj.get("proxy") is not None else None,
