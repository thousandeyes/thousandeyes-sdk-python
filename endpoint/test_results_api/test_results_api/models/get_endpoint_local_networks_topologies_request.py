...
class GetEndpointLocalNetworksTopologiesRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "searchFilters": EndpointNetworkTopologyResultRequestFilter.from_dict(obj.get("searchFilters")) if obj.get("searchFilters") is not None else None
        })
        return _obj
