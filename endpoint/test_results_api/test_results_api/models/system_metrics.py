...
class SystemMetrics(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "cpuUtilization": CpuUtilization.from_dict(obj.get("cpuUtilization")) if obj.get("cpuUtilization") is not None else None,
            "physicalMemoryUsedBytes": PhysicalMemoryUsedBytes.from_dict(obj.get("physicalMemoryUsedBytes")) if obj.get("physicalMemoryUsedBytes") is not None else None,
