...
class PathVisDynamicTestResult(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["agentId", "aid", "roundId", "serverIp", "systemMetrics", "vpnProfile", "asnDetails", "server", "sourceIp", "sourcePrefix", "application", "webex", "location", "endpoints"]
