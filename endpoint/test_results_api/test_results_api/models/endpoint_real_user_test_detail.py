...
class EndpointRealUserTestDetail(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "browser": EndpointBrowser.from_dict(obj.get("browser")) if obj.get("browser") is not None else None,
            "coordinates": RealUserTestCoordinates.from_dict(obj.get("coordinates")) if obj.get("coordinates") is not None else None,
            "pages": [RealUserTestPage.from_dict(_item) for _item in obj.get("pages")] if obj.get("pages") is not None else None,
            "network": RealUserTestNetwork.from_dict(obj.get("network")) if obj.get("network") is not None else None
        })
        return _obj
