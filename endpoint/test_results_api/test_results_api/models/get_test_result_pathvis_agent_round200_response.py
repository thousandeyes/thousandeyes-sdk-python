...
class GetTestResultPathvisAgentRound200Response(BaseModel):
    """
    GetTestResultPathvisAgentRound200Response
    """ # noqa: E501
    results: Optional[List[PathVisDetailTestResult]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "results": [PathVisDetailTestResult.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
