...
class GetEndpointRealUserTests200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "results": [EndpointRealUserTest.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
