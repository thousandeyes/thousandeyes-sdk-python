...
class EndpointTestLinks(BaseModel):
    ...
    """ # noqa: E501
    var_self: Optional[EndpointTestLinksSelf] = Field(default=None, alias="self")
    test_results: Optional[EndpointTestLinksTestResults] = Field(default=None, alias="testResults")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "self": EndpointTestLinksSelf.from_dict(obj.get("self")) if obj.get("self") is not None else None,
            "testResults": EndpointTestLinksTestResults.from_dict(obj.get("testResults")) if obj.get("testResults") is not None else None
        })
        return _obj
