...
class NetworkProxyProfile(BaseModel):
    ...
    NetworkProxyProfile
    """ # noqa: E501
    method: Optional[StrictStr] = Field(default=None, description="Proxy profile method.")
    proxies: Optional[List[NetworkProxyProfileProxiesInner]] = None
    __properties: ClassVar[List[str]] = ["method", "proxies"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "proxies": [NetworkProxyProfileProxiesInner.from_dict(_item) for _item in obj.get("proxies")] if obj.get("proxies") is not None else None
        })
        return _obj
