...
class GetEndpointRealUserTestDetails200Response(BaseModel):
    """
    GetEndpointRealUserTestDetails200Response
    """ # noqa: E501
    results: Optional[List[EndpointRealUserTestDetail]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "results": [EndpointRealUserTestDetail.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
