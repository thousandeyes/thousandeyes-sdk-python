...
class NetworkDynamicTestsResultsApi:
    ...
    @validate_call
    def get_dynamic_test_result_network_pathvis(
        self,
        ...
        _param = self._get_dynamic_test_result_network_pathvis_serialize(
            test_id=test_id,
            aid=aid,
            window=window,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetDynamicTestResultNetworkPathvis200Response",
    ...
    @validate_call
    def get_dynamic_test_result_network_pathvis_with_http_info(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        window: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="A dynamic time interval up to the current time of the request. Specify the interval as a number followed by an optional type: `s` for seconds (default if no type is specified), `m` for minutes, `h` for hours, `d` for days, and `w` for weeks. For a precise date range, use `startDate` and `endDate`.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetDynamicTestResultNetworkPathvis200Response]:
        """Retrieve pathvis network dynamic test results
    ...
    @validate_call
    def get_dynamic_test_result_network_pathvis_without_preload_content(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        window: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="A dynamic time interval up to the current time of the request. Specify the interval as a number followed by an optional type: `s` for seconds (default if no type is specified), `m` for minutes, `h` for hours, `d` for days, and `w` for weeks. For a precise date range, use `startDate` and `endDate`.")] = None,
    ...
    def _get_dynamic_test_result_network_pathvis_serialize(
        self,
        test_id,
        aid,
        window,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v7/endpoint/test-results/dynamic-tests/{testId}/pathvis',
    ...
    @validate_call
    def get_dynamic_test_result_pathvis_agent_round(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        ...
        _param = self._get_dynamic_test_result_pathvis_agent_round_serialize(
            test_id=test_id,
            agent_id=agent_id,
            round_id=round_id,
            aid=aid,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetDynamicTestResultPathvisAgentRound200Response",
            '400': "Error",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
    ...
    @validate_call
    def get_dynamic_test_result_pathvis_agent_round_with_http_info(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        agent_id: Annotated[StrictStr, Field(description="Agent ID")],
        round_id: Annotated[StrictStr, Field(description="Round ID")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetDynamicTestResultPathvisAgentRound200Response]:
        """Retrieve pathvis network dynamic test results details
    ...
    @validate_call
    def get_dynamic_test_result_pathvis_agent_round_without_preload_content(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        agent_id: Annotated[StrictStr, Field(description="Agent ID")],
        round_id: Annotated[StrictStr, Field(description="Round ID")],
    ...
    def _get_dynamic_test_result_pathvis_agent_round_serialize(
        self,
        test_id,
        agent_id,
        round_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v7/endpoint/test-results/dynamic-tests/{testId}/pathvis/agent/{agentId}/round/{roundId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def post_fetch_dynamic_test_result_metrics(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        window: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="A dynamic time interval up to the current time of the request. Specify the interval as a number followed by an optional type: `s` for seconds (default if no type is specified), `m` for minutes, `h` for hours, `d` for days, and `w` for weeks. For a precise date range, use `startDate` and `endDate`.")] = None,
        ...
        end_date: Annotated[Optional[datetime], Field(description="Defaults to current time the request is made. Use with the `startDate` parameter. Include the complete time (hours, minutes, and seconds) in UTC time zone, following the ISO 8601 date-time format. See the example for reference. Please note that this parameter can't be used with `window`.")] = None,
        cursor: Annotated[Optional[StrictStr], Field(description="(Optional) Opaque cursor used for pagination. Clients should use `_links` instead of this parameter.")] = None,
        dynamic_tests_data_round_search: Annotated[Optional[DynamicTestsDataRoundSearch], Field(description="Tests data search filters.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param cursor: (Optional) Opaque cursor used for pagination. Clients should use `_links` instead of this parameter.
        :type cursor: str
        :param dynamic_tests_data_round_search: Tests data search filters.
        :type dynamic_tests_data_round_search: DynamicTestsDataRoundSearch
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_fetch_dynamic_test_result_metrics_serialize(
            test_id=test_id,
            aid=aid,
            window=window,
            start_date=start_date,
            end_date=end_date,
            cursor=cursor,
            dynamic_tests_data_round_search=dynamic_tests_data_round_search,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PostFetchDynamicTestResultMetrics200Response",
            '401': "UnauthorizedError",
            '403': "Error",
            '404': "Error",
            '429': "Error",
    ...
    @validate_call
    def post_fetch_dynamic_test_result_metrics_with_http_info(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        window: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="A dynamic time interval up to the current time of the request. Specify the interval as a number followed by an optional type: `s` for seconds (default if no type is specified), `m` for minutes, `h` for hours, `d` for days, and `w` for weeks. For a precise date range, use `startDate` and `endDate`.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PostFetchDynamicTestResultMetrics200Response]:
        """Retrieve network dynamic test results
    ...
    @validate_call
    def post_fetch_dynamic_test_result_metrics_without_preload_content(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        window: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="A dynamic time interval up to the current time of the request. Specify the interval as a number followed by an optional type: `s` for seconds (default if no type is specified), `m` for minutes, `h` for hours, `d` for days, and `w` for weeks. For a precise date range, use `startDate` and `endDate`.")] = None,
    ...
    def _post_fetch_dynamic_test_result_metrics_serialize(
        self,
        test_id,
        aid,
        window,
        ...
        end_date,
        cursor,
        dynamic_tests_data_round_search,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if dynamic_tests_data_round_search is not None:
            _body_params = dynamic_tests_data_round_search
