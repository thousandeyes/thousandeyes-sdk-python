    ...
    def make_instance(self, include_optional) -> EndpointRealUserTestDetail:
        ...
        if include_optional:
            return EndpointRealUserTestDetail(
                ...
                browser = test_results_api.models.endpoint_browser.EndpointBrowser(
                    name = 'Google Chrome', 
                    version = '116.0.0.0', ),
                ...
                pages = [
                    test_results_api.models.real_user_test_page.RealUserTestPage(
                        page_id = 'C31gBrYJ', 
                ...
                network = test_results_api.models.real_user_test_network.RealUserTestNetwork(
