    ...
    def make_instance(self, include_optional) -> GetEndpointRealUserTestsNetwork200Response:
        ...
        if include_optional:
            return GetEndpointRealUserTestsNetwork200Response(
                ...
                results = [
                    test_results_api.models.real_user_test_network_result.RealUserTestNetworkResult(
                        agent_id = '861b7557-cd57-4bbb-b648-00bddf88ef49', 
                        date = '2022-07-17T22:00:54Z', 
                        id = '07625:1490529480:aVDViw0i', 
                        round_id = 1384309800, 
                        destination = test_results_api.models.network_metrics.NetworkMetrics(
                            jitter = 46, 
                            latency = 150, 
                            loss = 0.1, 
                            target = '54.208.6.220', ), 
                        vpn = test_results_api.models.network_metrics.NetworkMetrics(
                            jitter = 46, 
                            latency = 150, 
                            loss = 0.1, 
                            target = '54.208.6.220', ), 
