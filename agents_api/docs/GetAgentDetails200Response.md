...
get_agent_details200_response_instance = GetAgentDetails200Response.from_json(json)
# print the JSON string representation of the object
print GetAgentDetails200Response.to_json()

# convert the object into a dict
get_agent_details200_response_dict = get_agent_details200_response_instance.to_dict()
# create an instance of GetAgentDetails200Response from a dict
get_agent_details200_response_form_dict = get_agent_details200_response.from_dict(get_agent_details200_response_dict)
```
