...
from agents.api_client import ApiClient, RequestSerialized
from agents.api_response import ApiResponse
from agents.rest import RESTResponseType
...
class CloudAndEnterpriseAgentsApi:
    ...
    def update_enterprise_agent_details(
        self,
        agent_id: Annotated[StrictStr, Field(description="Unique ID for the agent.")],
        agent_request_body: AgentRequestBody,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        expand: Annotated[Optional[List[AgentDetailsExpand]], Field(description="Optional parameter, off by default. Indicates which agent sub-resource to expand. For example, if you wish to expand the `clusterMembers` sub-resource, pass the `?expand=cluster-member` query.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param agent_id: Unique ID for the agent. (required)
        :type agent_id: str
        :param agent_request_body: (required)
        :type agent_request_body: AgentRequestBody
        :param aid: A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.
        :type aid: str
        :param expand: Optional parameter, off by default. Indicates which agent sub-resource to expand. For example, if you wish to expand the `clusterMembers` sub-resource, pass the `?expand=cluster-member` query.
        :type expand: List[AgentDetailsExpand]
    ...
    def _update_enterprise_agent_details_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if agent_request_body is not None:
            _body_params = agent_request_body
