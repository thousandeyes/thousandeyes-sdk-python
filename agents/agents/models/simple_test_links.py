...
class SimpleTestLinks(BaseModel):
    """
    A list of links that can be accessed to get more information
    """ # noqa: E501
    var_self: Optional[SimpleTestLinksSelf] = Field(default=None, alias="self")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": SimpleTestLinksSelf.from_dict(obj["self"]) if obj.get("self") is not None else None,
