...
class TestDeployTestTemplateTests(unittest.TestCase):
    """DeployTestTemplateTests unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeployTestTemplateTests:
        """Test DeployTestTemplateTests
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeployTestTemplateTests`
        """
        model = DeployTestTemplateTests()
        if include_optional:
            return DeployTestTemplateTests(
                interval = 56
            )
        else:
            return DeployTestTemplateTests(
    ...
    def testDeployTestTemplateTests(self):
        """Test DeployTestTemplateTests"""
