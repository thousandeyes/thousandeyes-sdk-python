...
class TestDeployTestTemplate(unittest.TestCase):
    """DeployTestTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeployTestTemplate:
        ...
        # uncomment below to create an instance of `DeployTestTemplate`
        """
        model = DeployTestTemplate()
        if include_optional:
            return DeployTestTemplate(
                user_input_values = test_templates_api.models.deploy_test_template_user_input_values.DeployTestTemplate_userInputValues(
                    interval = 56, 
                    target = '', 
                    agents = '', 
                    domain = '', ),
                name = '',
                tests = test_templates_api.models.deploy_test_template_tests.DeployTestTemplate_tests(
                    interval = 56, )
            )
        else:
            return DeployTestTemplate(
    ...
    def testDeployTestTemplate(self):
        """Test DeployTestTemplate"""
