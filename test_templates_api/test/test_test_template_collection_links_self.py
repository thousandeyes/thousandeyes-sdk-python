...
class TestTestTemplateCollectionLinksSelf(unittest.TestCase):
    """TestTemplateCollectionLinksSelf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TestTemplateCollectionLinksSelf:
        """Test TestTemplateCollectionLinksSelf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TestTemplateCollectionLinksSelf`
        """
        model = TestTemplateCollectionLinksSelf()
        if include_optional:
            return TestTemplateCollectionLinksSelf(
    ...
    def testTestTemplateCollectionLinksSelf(self):
        """Test TestTemplateCollectionLinksSelf"""
