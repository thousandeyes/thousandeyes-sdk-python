...
class TestUserInputDefaultValue(unittest.TestCase):
    """UserInputDefaultValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserInputDefaultValue:
        """Test UserInputDefaultValue
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserInputDefaultValue`
        """
        model = UserInputDefaultValue()
        if include_optional:
            return UserInputDefaultValue(
            )
        else:
            return UserInputDefaultValue(
        )
    ...
    def testUserInputDefaultValue(self):
        """Test UserInputDefaultValue"""
