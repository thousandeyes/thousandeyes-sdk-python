...
class TestUserInput(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UserInput:
        """Test UserInput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserInput`
        """
        model = UserInput()
        if include_optional:
            return UserInput(
                name = 'target',
                title = 'Test Target',
                description = 'The target of the Tests',
