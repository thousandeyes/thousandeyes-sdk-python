...
class TestDeployTestTemplateUserInputValues(unittest.TestCase):
    """DeployTestTemplateUserInputValues unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeployTestTemplateUserInputValues:
        """Test DeployTestTemplateUserInputValues
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeployTestTemplateUserInputValues`
        """
        model = DeployTestTemplateUserInputValues()
        if include_optional:
            return DeployTestTemplateUserInputValues(
                interval = 56,
                target = '',
                agents = '',
                domain = ''
    ...
    def testDeployTestTemplateUserInputValues(self):
        """Test DeployTestTemplateUserInputValues"""
