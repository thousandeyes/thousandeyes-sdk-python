...
class TestTemplateUpsert(BaseModel):
    """
    The test template to create or update.
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the test template.")
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "icon", "isBuiltIn", "userInputs", "labels", "tests", "alertRules", "dashboards", "deploymentStrategy"]
