...
class TestTemplateCollectionLinks(BaseModel):
    """
    TestTemplateCollectionLinks
    """ # noqa: E501
    var_self: Optional[TestTemplateCollectionLinksSelf] = Field(default=None, alias="self")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of TestTemplateCollectionLinks from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of TestTemplateCollectionLinks from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "self": TestTemplateCollectionLinksSelf.from_dict(obj.get("self")) if obj.get("self") is not None else None
        })
        return _obj
