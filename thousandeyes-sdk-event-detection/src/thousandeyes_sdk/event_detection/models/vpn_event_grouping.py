...
class VpnEventGrouping(BaseModel):
    """
    VpnEventGrouping
    """ # noqa: E501
    vpn_type: Optional[StrictStr] = Field(default=None, description="VPN type (for vpn events).", alias="vpnType")
    vpn_server_ip_address: Optional[StrictStr] = Field(default=None, description="VPN server IP address (for vpn events).", alias="vpnServerIpAddress")
    __properties: ClassVar[List[str]] = ["vpnType", "vpnServerIpAddress"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vpnServerIpAddress": obj.get("vpnServerIpAddress")
        })
        return _obj
