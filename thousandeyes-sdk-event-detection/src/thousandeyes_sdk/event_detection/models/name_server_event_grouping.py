...
class NameServerEventGrouping(BaseModel):
    """
    NameServerEventGrouping
    """ # noqa: E501
    server_name: Optional[StrictStr] = Field(default=None, description="Name server hostname (for name-server events).", alias="serverName")
    __properties: ClassVar[List[str]] = ["serverName"]
