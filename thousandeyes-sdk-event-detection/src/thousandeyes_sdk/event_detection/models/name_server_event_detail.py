...
class NameServerEventDetail(BaseModel):
    """
    ...
    type: Annotated[str, Field(strict=True)] = Field(description="Name server event type.")
    grouping: Optional[NameServerEventGrouping] = None
    ...
    def type_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^name-server$", value):
            raise ValueError(r"must validate the regular expression /^name-server$/")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "grouping": NameServerEventGrouping.from_dict(obj["grouping"]) if obj.get("grouping") is not None else None
        })
        return _obj
