...
class WirelessEventGrouping(BaseModel):
    """
    WirelessEventGrouping
    """ # noqa: E501
    ssid: Optional[StrictStr] = Field(default=None, description="Wireless network SSID (for wireless events).")
    bssid: Optional[StrictStr] = Field(default=None, description="Wireless network BSSID (for wireless events).")
    __properties: ClassVar[List[str]] = ["ssid", "bssid"]
