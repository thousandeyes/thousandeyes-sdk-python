...
class VpnEventDetail(BaseModel):
    """
    VpnEventDetail
    """ # noqa: E501
    ...
    type: Annotated[str, Field(strict=True)] = Field(description="VPN event type.")
    grouping: Optional[VpnEventGrouping] = None
    ...
    def type_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^vpn$", value):
            raise ValueError(r"must validate the regular expression /^vpn$/")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "grouping": VpnEventGrouping.from_dict(obj["grouping"]) if obj.get("grouping") is not None else None
        })
        return _obj
