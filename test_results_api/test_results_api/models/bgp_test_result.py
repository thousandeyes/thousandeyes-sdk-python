...
class BgpTestResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["date", "roundId", "_links", "monitor", "prefixId", "prefix", "updates", "pathChanges", "reachability"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "monitor": Monitor.from_dict(obj.get("monitor")) if obj.get("monitor") is not None else None,
