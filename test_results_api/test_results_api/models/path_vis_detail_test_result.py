...
class PathVisDetailTestResult(BaseModel):
    ...
    routes: Optional[List[PathVisRoute]] = Field(default=None, description="Shows 3 iterations of path trace, with each iteration specified by a pathId")
    __properties: ClassVar[List[str]] = ["date", "roundId", "_links", "startTime", "endTime", "agent", "server", "serverIp", "sourceIp", "sourcePrefix", "targetIsProxy", "direction", "routes"]
