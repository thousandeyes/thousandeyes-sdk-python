...
class WebTransactionPageDetailTestResult(BaseModel):
    ...
    har: Optional[Union[str, Any]] = Field(default=None, description="See [HAR specification](http://www.softwareishard.com/blog/har-12-spec/) for details")
    __properties: ClassVar[List[str]] = ["date", "roundId", "_links", "agent", "componentErrors", "transactionTime", "errorType", "errorDetails", "markers", "pages", "har"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "markers": [Marker.from_dict(_item) for _item in obj.get("markers")] if obj.get("markers") is not None else None,
