...
class WebTransactionDetailTestResult(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["date", "roundId", "_links", "agent", "componentErrors", "transactionTime", "errorType", "errorDetails", "markers", "pages"]
