...
class GetTestResultsBgp200Response(BaseModel):
    """
    GetTestResultsBgp200Response
    """ # noqa: E501
    results: Optional[List[BgpTestResult]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "results": [BgpTestResult.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
