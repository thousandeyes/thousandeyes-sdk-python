...
class GetTestResultDnssec200Response(BaseModel):
    """
    ...
    results: Optional[List[DnssecTestResult]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "results": [DnssecTestResult.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
