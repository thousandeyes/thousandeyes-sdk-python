...
class GetTestResultWebTransactionsComponentDetail200Response(BaseModel):
    """
    GetTestResultWebTransactionsComponentDetail200Response
    """ # noqa: E501
    results: Optional[List[WebTransactionDetailTestResult]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "results": [WebTransactionDetailTestResult.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
