...
class HttpTestResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["date", "roundId", "_links", "agent", "serverIp", "responseCode", "numRedirects", "redirectTime", "dnsTime", "sslTime", "connectTime", "waitTime", "receiveTime", "wireSize", "responseTime", "throughput", "totalTime", "headers", "errorType", "errorDetails", "sslCipher", "sslVersion", "sslCertificates"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "sslCertificates": [SslCert.from_dict(_item) for _item in obj.get("sslCertificates")] if obj.get("sslCertificates") is not None else None
        })
        return _obj
