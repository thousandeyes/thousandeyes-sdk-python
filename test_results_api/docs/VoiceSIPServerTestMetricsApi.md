# test_results_api.VoiceSIPServerTestMetricsApi
...
> GetTestResultSipServer200Response get_test_result_sip_server(test_id, aid=aid, window=window, start_date=start_date, end_date=end_date, cursor=cursor)
...
with test_results_api.ApiClient(configuration) as api_client:
    ...
    api_instance = test_results_api.VoiceSIPServerTestMetricsApi(api_client)
