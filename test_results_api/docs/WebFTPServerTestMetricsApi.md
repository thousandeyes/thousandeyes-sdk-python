# test_results_api.WebFTPServerTestMetricsApi
...
> GetTestResultFtpServer200Response get_test_result_ftp_server(test_id, aid=aid, window=window, start_date=start_date, end_date=end_date, cursor=cursor)
...
with test_results_api.ApiClient(configuration) as api_client:
    ...
    api_instance = test_results_api.WebFTPServerTestMetricsApi(api_client)
