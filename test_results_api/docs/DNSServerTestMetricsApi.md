# test_results_api.DNSServerTestMetricsApi
...
> GetTestResultDnsServer200Response get_test_result_dns_server(test_id, server_id, aid=aid, window=window, start_date=start_date, end_date=end_date, cursor=cursor)
...
with test_results_api.ApiClient(configuration) as api_client:
    ...
    api_instance = test_results_api.DNSServerTestMetricsApi(api_client)
...
> GetTestResultDnsServer200Response get_test_result_dns_servers(test_id, aid=aid, window=window, start_date=start_date, end_date=end_date, cursor=cursor)
