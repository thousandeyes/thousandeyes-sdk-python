# test_results_api.DNSSECTestMetricsApi
...
> GetTestResultDnssec200Response get_test_result_dnssec(test_id, aid=aid, window=window, start_date=start_date, end_date=end_date, cursor=cursor)
