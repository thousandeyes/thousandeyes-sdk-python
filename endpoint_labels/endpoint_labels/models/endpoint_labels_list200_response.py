...
class EndpointLabelsList200Response(BaseModel):
    """
    EndpointLabelsList200Response
    """ # noqa: E501
    labels: Optional[List[LabelsLabelsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "labels": [LabelsLabelsInner.from_dict(_item) for _item in obj["labels"]] if obj.get("labels") is not None else None,
