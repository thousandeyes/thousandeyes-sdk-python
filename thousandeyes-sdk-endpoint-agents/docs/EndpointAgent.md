...
**free_disk_space_normalized** | **float** | Free storage space as a normalized percentage (0-1). | [optional] [readonly] 
...
**nic_driver_version** | **str** | Network interface card driver version. | [optional] [readonly] 
**nic_model** | **str** | Network interface card model. | [optional] [readonly] 
