...
> BulkAgentTransferResponse endpoint_agent_bulk_transfer(aid=aid, bulk_agent_transfer_request=bulk_agent_transfer_request)
...
with thousandeyes_sdk.endpoint_agents.ApiClient(configuration) as api_client:
    ...
    try:
        # Bulk transfer agents
        api_response = api_instance.endpoint_agent_bulk_transfer(aid=aid, bulk_agent_transfer_request=bulk_agent_transfer_request)
