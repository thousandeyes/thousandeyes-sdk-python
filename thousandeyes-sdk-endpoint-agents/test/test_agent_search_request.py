    ...
    def make_instance(self, include_optional) -> AgentSearchRequest:
        ...
        if include_optional:
            return AgentSearchRequest(
                ...
                threshold_filter = thousandeyes_sdk.endpoint_agents.models.agent_threshold_filters.AgentThresholdFilters(
                    filters = [
                ...
                search_sort = [
                    thousandeyes_sdk.endpoint_agents.models.agent_search_sort.AgentSearchSort(
                        sort = 'platform', 
                        order = 'desc', )
                    ]
            )
