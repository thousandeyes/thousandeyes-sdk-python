...
class BulkAgentTransferResponse(BaseModel):
    """
    BulkAgentTransferResponse
    """ # noqa: E501
    items: Optional[List[AgentTransferStatus]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [AgentTransferStatus.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
