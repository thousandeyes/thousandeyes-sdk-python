...
class TestAgentToServerEndpointScheduledTestsApi(unittest.TestCase):
    """AgentToServerEndpointScheduledTestsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = AgentToServerEndpointScheduledTestsApi()
