...
class DynamicTestRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["agentSelectorType", "agents", "endpointAgentLabels", "tagIds", "isPrioritized", "interval", "maxMachines", "application", "protocol", "tcpProbeMode", "testName", "hasPathTraceInSession", "ipVersion"]
