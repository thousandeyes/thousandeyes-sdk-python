...
class EndpointAgentToServerTestRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["agentSelectorType", "agents", "endpointAgentLabels", "tagIds", "maxMachines", "testName", "ipVersion", "serverName", "server", "port", "isPrioritized", "interval", "protocol"]
