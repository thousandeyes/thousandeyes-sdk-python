...
class EndpointHttpServerTestRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["agentSelectorType", "agents", "endpointAgentLabels", "maxMachines", "port", "testName", "authType", "hasPathTraceInSession", "httpTimeLimit", "protocol", "url", "username", "sslVersionId", "tcpProbeMode", "verifyCertificate", "hasPing", "hasTraceroute", "networkMeasurements", "targetResponseTime", "password", "interval"]
