...
class ApiRequest(BaseModel):
    ...
    collect_api_response: Optional[StrictStr] = Field(default='true', description="Set to `true` if API response body should be collected and saved. Set to `false` if API response body should not be saved.", alias="collectApiResponse")
    ...
    wait_time_ms: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Post request delay before executing the next API requests, in milliseconds.", alias="waitTimeMs")
