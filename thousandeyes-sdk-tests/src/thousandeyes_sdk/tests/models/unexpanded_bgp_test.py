...
class UnexpandedBgpTest(BaseModel):
    """
    UnexpandedBgpTest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["createdBy", "createdDate", "description", "liveShare", "modifiedBy", "modifiedDate", "savedEvent", "testId", "testName", "type", "_links", "enabled", "includeCoveredPrefixes", "usePublicBgp", "alertsEnabled", "prefix"]
