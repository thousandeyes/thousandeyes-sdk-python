...
class BgpTestRequest(BaseModel):
    """
    BgpTestRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["createdBy", "createdDate", "description", "liveShare", "modifiedBy", "modifiedDate", "savedEvent", "testId", "testName", "type", "_links", "enabled", "includeCoveredPrefixes", "usePublicBgp", "alertsEnabled", "prefix", "labels", "tags", "sharedWithAccounts", "alertRules", "monitors"]
