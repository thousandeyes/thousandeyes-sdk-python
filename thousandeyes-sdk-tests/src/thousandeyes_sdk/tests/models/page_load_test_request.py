...
class PageLoadTestRequest(BaseModel):
    """
    PageLoadTestRequest
    """ # noqa: E501
    ...
    agents: List[TestAgentRequest] = Field(description="Agents assigned to the test.")
