...
class AgentToAgentTestsApi:
    ...
    def create_agent_to_agent_test(
        ...
        :param agent_to_agent_test_request: (required)
        :type agent_to_agent_test_request: AgentToAgentTestRequest
    ...
    def _create_agent_to_agent_test_serialize(
        ...
        if agent_to_agent_test_request is not None:
            _body_params = agent_to_agent_test_request
