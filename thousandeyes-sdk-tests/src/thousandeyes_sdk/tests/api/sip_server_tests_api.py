...
class SIPServerTestsApi:
    ...
    def create_sip_server_test(
        ...
        :param sip_server_test_request: (required)
        :type sip_server_test_request: SipServerTestRequest
    ...
    def _create_sip_server_test_serialize(
        ...
        if sip_server_test_request is not None:
            _body_params = sip_server_test_request
