...
class PageLoadTestsApi:
    ...
    def create_page_load_test(
        ...
        :param page_load_test_request: (required)
        :type page_load_test_request: PageLoadTestRequest
        ...
        _param = self._create_page_load_test_serialize(
    ...
    @validate_call
    def create_page_load_test_without_preload_content(
        self,
        page_load_test_request: PageLoadTestRequest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        expand: Annotated[Optional[List[ExpandTestOptions]], Field(description="Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.")] = None,
    ...
    def _create_page_load_test_serialize(
        self,
        page_load_test_request,
        aid,
        expand,
        _request_auth,
        _content_type,
        ...
        if page_load_test_request is not None:
            _body_params = page_load_test_request
    ...
    def delete_page_load_test(
        ...
        _param = self._delete_page_load_test_serialize(
            test_id=test_id,
            aid=aid,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def delete_page_load_test_without_preload_content(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
    ...
    def _delete_page_load_test_serialize(
        self,
        test_id,
        aid,
        _request_auth,
    ...
    def get_page_load_test(
        ...
        _param = self._get_page_load_test_serialize(
            test_id=test_id,
            aid=aid,
            expand=expand,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_page_load_test_with_http_info(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        expand: Annotated[Optional[List[ExpandTestOptions]], Field(description="Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.")] = None,
    ...
    def _get_page_load_test_serialize(
        self,
        test_id,
        aid,
        expand,
    ...
    def get_page_load_tests(
        ...
        _param = self._get_page_load_tests_serialize(
            aid=aid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_page_load_tests_with_http_info(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_page_load_tests_without_preload_content(
        self,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_page_load_tests_serialize(
        self,
        aid,
        _request_auth,
        _content_type,
    ...
    def update_page_load_test(
        ...
        _param = self._update_page_load_test_serialize(
            test_id=test_id,
            page_load_test_request=page_load_test_request,
            aid=aid,
            expand=expand,
    ...
    @validate_call
    def update_page_load_test_without_preload_content(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        page_load_test_request: PageLoadTestRequest,
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
    ...
    def _update_page_load_test_serialize(
        self,
        test_id,
        page_load_test_request,
        aid,
