...
class DNSTraceTestsApi:
    ...
    def create_dns_trace_test(
        ...
        :param dns_trace_test_request: (required)
        :type dns_trace_test_request: DnsTraceTestRequest
    ...
    def _create_dns_trace_test_serialize(
        ...
        if dns_trace_test_request is not None:
            _body_params = dns_trace_test_request
