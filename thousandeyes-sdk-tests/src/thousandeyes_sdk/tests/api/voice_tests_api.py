...
class VoiceTestsApi:
    ...
    def create_voice_test(
        ...
        :param voice_test_request: (required)
        :type voice_test_request: VoiceTestRequest
    ...
    def _create_voice_test_serialize(
        ...
        if voice_test_request is not None:
            _body_params = voice_test_request
