...
class DNSSECTestsApi:
    ...
    def create_dns_sec_test(
        ...
        :param dns_sec_test_request: (required)
        :type dns_sec_test_request: DnsSecTestRequest
    ...
    def _create_dns_sec_test_serialize(
        ...
        if dns_sec_test_request is not None:
            _body_params = dns_sec_test_request
