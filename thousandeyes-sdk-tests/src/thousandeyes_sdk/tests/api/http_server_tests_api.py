...
class HTTPServerTestsApi:
    ...
    def create_http_server_test(
        ...
        :param http_server_test_request: (required)
        :type http_server_test_request: HttpServerTestRequest
    ...
    def _create_http_server_test_serialize(
        ...
        if http_server_test_request is not None:
            _body_params = http_server_test_request
