...
class TestBGPApi(unittest.TestCase):
    ...
    def test_create_bgp_test_models_validation(self) -> None:
        ...
        request_from_json = thousandeyes_sdk.tests.models.UpdateBgpTest.from_json(request_body_json)
        ...
        response_from_json = thousandeyes_sdk.tests.models.BgpTest.from_json(response_body_json)
