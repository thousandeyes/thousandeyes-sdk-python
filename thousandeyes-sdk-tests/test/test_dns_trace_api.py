...
class TestDNSTraceApi(unittest.TestCase):
    ...
    def test_create_dns_trace_test_models_validation(self) -> None:
        ...
        request_from_json = thousandeyes_sdk.tests.models.UpdateDnsTraceTest.from_json(request_body_json)
        ...
        response_from_json = thousandeyes_sdk.tests.models.DnsTraceTest.from_json(response_body_json)
