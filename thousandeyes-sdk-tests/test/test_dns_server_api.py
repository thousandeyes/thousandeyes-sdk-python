...
class TestDNSServerApi(unittest.TestCase):
    ...
    def test_create_dns_server_test_models_validation(self) -> None:
        ...
        request_from_json = thousandeyes_sdk.tests.models.UpdateDnsServerTest.from_json(request_body_json)
        ...
        response_from_json = thousandeyes_sdk.tests.models.DnsServerTest.from_json(response_body_json)
