...
class TestPageLoadTestsApi(unittest.TestCase):
    """PageLoadTestsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PageLoadTestsApi()
    ...
    def test_create_page_load_test_models_validation(self) -> None:
        ...
        response_from_json = thousandeyes_sdk.tests.models.PageLoadTestResponse.from_json(response_body_json)
