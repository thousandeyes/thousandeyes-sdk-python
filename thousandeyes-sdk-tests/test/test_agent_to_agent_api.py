...
class TestAgentToAgentApi(unittest.TestCase):
    ...
    def test_create_agent_to_agent_test_models_validation(self) -> None:
        """Test case for create_agent_to_agent_test request and response models"""
        request_body_json = """
                {
                  "_links" : {
                    "testResults" : [ {
        ...
        request_from_json = thousandeyes_sdk.tests.models.UpdateAgentToAgentTest.from_json(request_body_json)
        ...
        response_from_json = thousandeyes_sdk.tests.models.AgentToAgentTest.from_json(response_body_json)
