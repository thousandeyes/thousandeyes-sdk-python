...
class TestAgentToServerApi(unittest.TestCase):
    ...
    def test_create_agent_to_server_test_models_validation(self) -> None:
        ...
        request_from_json = thousandeyes_sdk.tests.models.UpdateAgentToServerTest.from_json(request_body_json)
        ...
        response_from_json = thousandeyes_sdk.tests.models.AgentToServerTest.from_json(response_body_json)
