...
class TestSIPServerApi(unittest.TestCase):
    ...
    def test_create_sip_server_test_models_validation(self) -> None:
        """Test case for create_sip_server_test request and response models"""
        request_body_json = """
                {
        ...
        request_from_json = thousandeyes_sdk.tests.models.UpdateSipServerTest.from_json(request_body_json)
        ...
        response_from_json = thousandeyes_sdk.tests.models.SipServerTest.from_json(response_body_json)
