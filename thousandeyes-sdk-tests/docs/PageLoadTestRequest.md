...
**agents** | [**List[TestAgentRequest]**](TestAgentRequest.md) | Agents assigned to the test. | 
...
json = "{}"
# create an instance of PageLoadTestRequest from a JSON string
page_load_test_request_instance = PageLoadTestRequest.from_json(json)
# print the JSON string representation of the object
print(PageLoadTestRequest.to_json())

# convert the object into a dict
page_load_test_request_dict = page_load_test_request_instance.to_dict()
# create an instance of PageLoadTestRequest from a dict
page_load_test_request_from_dict = PageLoadTestRequest.from_dict(page_load_test_request_dict)
```
