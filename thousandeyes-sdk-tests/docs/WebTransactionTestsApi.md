...
with thousandeyes_sdk.core.ApiClient(configuration) as api_client:
    ...
    web_transaction_test_request =  # WebTransactionTestRequest | 
...
> WebTransactionTestResponse get_web_transactions_test(test_id, aid=aid, version_id=version_id, expand=expand)
...
with thousandeyes_sdk.core.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Web Transactions test
        api_response = api_instance.get_web_transactions_test(test_id, aid=aid, version_id=version_id, expand=expand)
