...
**agents** | [**List[TestAgentWithSourceIpRequest]**](TestAgentWithSourceIpRequest.md) | Agents assigned to the test. To select a source interface, set &#x60;sourceIpAddress&#x60; on the same object as its &#x60;agentId&#x60;. | 
