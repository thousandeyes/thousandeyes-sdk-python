...
json = "{}"
# create an instance of DnsSecTestRequest from a JSON string
dns_sec_test_request_instance = DnsSecTestRequest.from_json(json)
# print the JSON string representation of the object
print(DnsSecTestRequest.to_json())

# convert the object into a dict
dns_sec_test_request_dict = dns_sec_test_request_instance.to_dict()
# create an instance of DnsSecTestRequest from a dict
dns_sec_test_request_from_dict = DnsSecTestRequest.from_dict(dns_sec_test_request_dict)
```
