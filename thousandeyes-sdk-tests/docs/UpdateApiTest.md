...
json = "{}"
# create an instance of UpdateApiTest from a JSON string
update_api_test_instance = UpdateApiTest.from_json(json)
# print the JSON string representation of the object
print(UpdateApiTest.to_json())

# convert the object into a dict
update_api_test_dict = update_api_test_instance.to_dict()
# create an instance of UpdateApiTest from a dict
update_api_test_from_dict = UpdateApiTest.from_dict(update_api_test_dict)
```
