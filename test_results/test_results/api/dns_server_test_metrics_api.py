...
class DNSServerTestMetricsApi:
    ...
    @validate_call
    def get_test_result_dns_server(
        self,
        ...
        _param = self._get_test_result_dns_server_serialize(
            test_id=test_id,
            server_id=server_id,
            aid=aid,
            window=window,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetTestResultDnsServer200Response",
            '400': "ValidationError",
    ...
    def get_test_result_dns_server_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetTestResultDnsServer200Response]:
        """Get DNS server test results by server
    ...
    def _get_test_result_dns_server_serialize(
        self,
        test_id,
        server_id,
        aid,
    ...
    @validate_call
    def get_test_result_dns_servers(
        self,
        test_id: Annotated[StrictStr, Field(description="Test ID")],
        aid: Annotated[Optional[StrictStr], Field(description="A unique identifier associated with your account group. You can retrieve your `AccountGroupId` from the `/account-groups` endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.")] = None,
        window: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="A dynamic time interval up to the current time of the request. Specify the interval as a number followed by an optional type: `s` for seconds (default if no type is specified), `m` for minutes, `h` for hours, `d` for days, and `w` for weeks. For a precise date range, use `startDate` and `endDate`.")] = None,
        ...
        _param = self._get_test_result_dns_servers_serialize(
            test_id=test_id,
            aid=aid,
            window=window,
            start_date=start_date,
    ...
    def _get_test_result_dns_servers_serialize(
        self,
        test_id,
        aid,
        window,
