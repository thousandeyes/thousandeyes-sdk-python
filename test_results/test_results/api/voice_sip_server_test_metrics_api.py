...
class VoiceSIPServerTestMetricsApi:
    ...
    @validate_call
    def get_test_result_sip_server(
        self,
        ...
        _param = self._get_test_result_sip_server_serialize(
            test_id=test_id,
            aid=aid,
            window=window,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetTestResultSipServer200Response",
            '400': "ValidationError",
    ...
    def get_test_result_sip_server_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetTestResultSipServer200Response]:
        """Get SIP server test results
    ...
    def _get_test_result_sip_server_serialize(
        self,
        test_id,
        aid,
        window,
