...
class TestStreamResponseLinksSelf(unittest.TestCase):
    """StreamResponseLinksSelf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StreamResponseLinksSelf:
        ...
        # uncomment below to create an instance of `StreamResponseLinksSelf`
        """
        model = StreamResponseLinksSelf()
        if include_optional:
            return StreamResponseLinksSelf(
    ...
    def testStreamResponseLinksSelf(self):
        """Test StreamResponseLinksSelf"""
