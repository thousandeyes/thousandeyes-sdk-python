...
class Stream(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["customHeaders", "tagMatch", "enabled", "type", "endpointType", "streamEndpointUrl"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tagMatch": [PutStreamTagMatchInner.from_dict(_item) for _item in obj["tagMatch"]] if obj.get("tagMatch") is not None else None,
