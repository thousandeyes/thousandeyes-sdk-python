...
class StreamResponse(BaseModel):
    ...
    enabled: Optional[StrictBool] = Field(default=None, description="Flag to indicate if the stream integration is currently enabled.")
    links: Optional[StreamResponseLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["id", "enabled", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": StreamResponseLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
